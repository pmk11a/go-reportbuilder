object FrMainCloseSO: TFrMainCloseSO
  Left = 335
  Top = 167
  Width = 1036
  Height = 532
  Caption = 'Sales Order - Close'
  Color = 16767411
  ...
  object dxPageControl1: TdxPageControl
    ...
    object dxTSDafSJ: TdxTabSheet
      ...
      object cxGrid1: TcxGrid
        ...
        object tvMaster: TcxGridDBTableView
          ...
          object tvMasterKeyNoBuktiUrut: TcxGridDBColumn
            DataBinding.FieldName = 'KeyNoBuktiUrut'
            Visible = False
          end
          ...
          object tvMasterKodeBrg: TcxGridDBColumn
            Caption = 'Kode Barang'
            DataBinding.FieldName = 'KodeBrg'
            Width = 100
          end
          object tvMasterNamaBrg: TcxGridDBColumn
            Caption = 'Nama Barang'
          ...
          object tvMasterQntSPP: TcxGridDBColumn
            Caption = 'Qnt SPP'
            DataBinding.FieldName = 'QntSPP'
            HeaderAlignmentHorz = taRightJustify
            Width = 80
          end
          object tvMasterQntSisa: TcxGridDBColumn
            Caption = 'Qnt Sisa'
            DataBinding.FieldName = 'QntSisa'
            HeaderAlignmentHorz = taRightJustify
            Width = 80
          end
          object tvMasterIsCloseDet: TcxGridDBColumn
            Caption = 'Close'
    ...
    object dxTSDafSO: TdxTabSheet
      Caption = 'Outstanding SO - Sales Order'
  ...
  object QuMaster: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'Select '#9'A.NoBukti+RIGHT('#39'00000000'#39'+CAST(B.Urut AS varchar(8)),8)' +
        ' KeyNoBuktiUrut, '
      
        #9'A.NoBukti, A.NoUrut, A.Tanggal, A.KodeCust, C.NamaCustSupp Nama' +
        'Cust,'
      
        #9'B.Urut, B.KodeBrg, Brg.NamaBrg, B.QNT, O.QntSPP, O.QntSisa, isn' +
        'ull(B.IsCloseDet,0) IsCloseDet '
      'From dbSO A'
      ...
      'left outer join dbBarang Brg on Brg.KodeBrg=B.KodeBrg'
        ...
        'left outer join vwOutSO_SPP O on O.NoBukti=A.NOBUKTI and O.NoBuk' +
        'ti=B.NOBUKTI and O.Urut=B.URUT'
      'where year(A.Tanggal)=@Tahun and month(A.Tanggal)=@Bulan'
      'order by A.NoBukti, B.URUT'
      '')
    Left = 24
    Top = 184
    object QuMasterKeyNoBuktiUrut: TStringField
      FieldName = 'KeyNoBuktiUrut'
      ReadOnly = True
      Size = 38
    end
    ...
    object QuMasterIsCloseDet: TBooleanField
