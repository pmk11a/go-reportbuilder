object FrMainBeli: TFrMainBeli
    ...
    object dxTabSheet1: TdxTabSheet
      ...
      object cxGrid2: TcxGrid
        ...
        object tvPO: TcxGridDBTableView
          ...
          object tvPOKodeSupp: TcxGridDBColumn
            Caption = 'Kode Supp'
          ...
          object tvPONamaCustSupp: TcxGridDBColumn
        ...
        object TVDetailPO: TcxGridDBTableView
          DataController.DataSource = dsdetailPO
          ...
          object cxGridDBColumn7: TcxGridDBColumn
            Caption = 'Qnt OS'
            DataBinding.FieldName = 'QNTOS'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Width = 70
          end
          object TVDetailPODBColumn1: TcxGridDBColumn
  ...
  object QuMaster: TADOQuery
    ...
    SQL.Strings = (
      ...
      '            end As Bit) NeedOtorisasi'
        ...
        '        ,Isnull(A.Isbatal,0)Isbatal,A.Userbatal,A.TglBatal ,noju' +
        'rnal'
      'From vwMasterBeli A'
  ...
  object QumasterPO: TADOQuery
    ...
    SQL.Strings = (
      ...
      'select @Tahun=2013, @Bulan=4'
        ...
        'Select A.NOBUKTI, A.TANGGAL, A.KODESUPP, d.NAMACUSTSUPP, A.KodeG' +
        'DG'
      'From DBPO A'
      
        '     Left Outer join (Select x.NOBUKTI,x.isclose, SUM(x.QNT) Qnt' +
        'PO, SUM(isnull(y.Qnt,0)) QntBeli'
      '                      from DBPODET x'
      
        '                           left outer join (Select x.NoPO, x.Uru' +
        'tPO, SUM(x.QNT) Qnt'
      '                                            from DBBELIDET x'
      
        '                                            Group by x.NoPO, x.U' +
        'rutPO) y on y.NoPO=x.NOBUKTI and y.UrutPO=x.URUT'
      '                      Group by x.NOBUKTI,x.isclose'
      
        '                       Having (SUM(x.QNT)-SUM(ISNULL(x.QntBatal,' +
        '0)))-SUM(isnull(y.Qnt,0))>0) B on B.NOBUKTI=A.NOBUKTI'
      '     Left Outer join vwBrowsSupp d on d.KODECUSTSUPP=a.KODESUPP'
        ...
        'end=A.MaxOL then 0'
      '                  else 1'
      '             end As Bit)=0 and B.NOBUKTI is not null and'
      
        '      cast(year(A.Tanggal) as varchar(4))+Case when month(A.tang' +
    ...
    object QumasterPOKodeSupp: TStringField
      FieldName = 'KodeSupp'
      Size = 15
    end
    object QumasterPONamaCustSupp: TStringField
      FieldName = 'NamaCustSupp'
      Size = 100
    end
  ...
  object QuDetailPO: TADOQuery
    Connection = DM.MyStock
    CursorType = ctStatic
    DataSource = dsMasterPO
    Parameters = <
      item
        Name = 'NoBukti'
        DataType = ftString
    ...
    Left = 96
    Top = 250
    object QuDetailPONoBukti: TStringField
      FieldName = 'NoBukti'
    end
    object QuDetailPOUrut: TIntegerField
      FieldName = 'Urut'
    end
    object QuDetailPOKodeBrg: TStringField
      FieldName = 'KodeBrg'
      Size = 25
    end
    object QuDetailPOQntBeliSat1: TBCDField
      FieldName = 'QntBeliSat1'
      ReadOnly = True
      DisplayFormat = ',0.00'
      Precision = 32
    end
    object QuDetailPONamaBrg: TStringField
      FieldName = 'NamaBrg'
      Size = 100
    end
    object QuDetailPOQntPO: TBCDField
      FieldName = 'QntPO'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    end
    object QuDetailPOSatuan: TStringField
      FieldName = 'Satuan'
      Size = 5
    end
    object QuDetailPOQNTOS: TBCDField
      FieldName = 'QNTOS'
      ReadOnly = True
      DisplayFormat = ',0.00'
      Precision = 32
    end
    object QuDetailPOSat1: TStringField
      FieldName = 'Sat1'
      Size = 5
    end
  end
