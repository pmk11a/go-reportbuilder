object FrMainBeliNota: TFrMainBeliNota
  Left = 236
  Top = 80
  Width = 976
  Height = 642
  ...
  object cxGrid1: TcxGrid
    ...
    object tvMaster: TcxGridDBTableView
      ...
      DataController.Summary.FooterSummaryItems = <
        ...
        item
          ...
          Kind = skSum
          FieldName = 'RpJumlah'
          Column = tvMasterTotTotalRp
        end
        item
          Format = ',0.00'
          Kind = skSum
          FieldName = 'TotDPPRp'
          Column = tvMasterTotDPPRp
        end
        item
          Format = ',0.00'
          Kind = skSum
          FieldName = 'TotPPNRp'
          Column = tvMasterTotPPNRp
        end
        item
          Format = ',0.00'
          Kind = skSum
      ...
      object tvMasterFakturSupp: TcxGridDBColumn
    ...
    object tvDetail: TcxGridDBTableView
      ...
      object tvDetailDiscP2: TcxGridDBColumn
        DataBinding.FieldName = 'DiscP2'
        HeaderAlignmentHorz = taCenter
        Width = 90
      end
      object tvDetailDiscRp2: TcxGridDBColumn
        Caption = 'Diskon 2'
        DataBinding.FieldName = 'DiscRp2'
        HeaderAlignmentHorz = taCenter
        Width = 90
      end
      object tvDetailHrgNetto: TcxGridDBColumn
        Caption = 'Harga Netto'
  ...
  object QuMaster: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'declare @Tahun int, @Bulan int ,@TorK int'
      ''
      ...
      'From vwMasterBeli A'
        ...
        'where year(A.Tanggal)=@Tahun and month(A.Tanggal)=@Bulan and fla' +
        'gtipe=@TorK'
      'order by A.NoBukti'
      ''
      ''
  ...
  object QuDetail1: TADOQuery
    ...
    SQL.Strings = (
      ...
      'select @Tahun=2009, @Bulan=9'
      ''
      'Select '#9'B.NoBukti, B.NoPO, B.UrutPO,'
      
        #9'B.Urut, B.KodeBrg,case when left (b.kodebrg,3)='#39'BLB'#39' then NamaB' +
        'arang else  H.NamaBrg end NamaBrg, B.Qnt, B.NoSat, B.Isi, B.Satu' +
        'an,'
      '        0.00 Qnt2, '#39#39' SatuanRoll, B.Harga, B.HrgNetto,'
      '        B.DiscP DiscP1, ndiskon/*B.DiscTot*/ DiscRp1, B.DiscTot,'
      '        B.SubTotal TotalUSD, B.SubTotal TotalIDR, B.NDPP NDPP,'
      
        '        B.NPPN NPPN, B.BYAngkut Beban, nnetrp/*B.SubTotal + B.BY' +
        'Angkut*/ Total, B.KodeGdg'
      'From  dbBeliDet B '
