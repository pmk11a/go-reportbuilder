object FrDebetB: TFrDebetB
  Left = 701
  Top = 160
  Width = 1084
  Height = 557
  Caption = 'Daftar Invoice Yang Belum Ada Debet Note'
  Color = clBtnFace
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      'from dbo.vwHutPiut a'
        ...
        '     left outer join (select NoInv from dbDebetNoteDet) b on b.N' +
        'oInv=a.NoFaktur'
      'where a.KodeCustSupp=@Awal and B.NoInv is null and a.Tipe='#39'HT'#39
