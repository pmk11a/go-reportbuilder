  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'A.Satuan SatPO,Isnull(b.Qnt,0)QntB,Isnull(B.Satuan,A.Satuan) Sat' +
        'BG,b.KodeGdg'
        ...
        'll(b1.FakturSupp,A1.FakturSupp)FakturSupp,A.Tolerate'
    ...
    object QuBeliQntPO: TBCDField
      FieldName = 'QntPO'
      Precision = 18
      Size = 2
    end
    object QuBeliSatPO: TStringField
      FieldName = 'SatPO'
      Size = 5
    end
    object QuBeliQntB: TBCDField
      FieldName = 'QntB'
      ReadOnly = True
      Precision = 32
    end
    object QuBeliSatBG: TStringField
      FieldName = 'SatBG'
      Size = 5
    end
    ...
    object QuBeliNosatPO: TWordField
      FieldName = 'NosatPO'
    end
    object QuBelisatSisa: TStringField
      FieldName = 'satSisa'
      ReadOnly = True
      Size = 5
    end
    object QuBeliQntSisa: TBCDField
      FieldName = 'QntSisa'
      ReadOnly = True
      Precision = 32
      Size = 2
  ...
  object QuReport: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'Select a.NoBukti NoPO,b.NoBukti,a.KodeBrg,d.namaBrg,a.Qnt QntPO,' +
        'A.Satuan SatPO,Isnull(b.Qnt,0)QntB,B.Satuan SatBG,b.KodeGdg'
      
        ',b1.Tanggal,a1.KodeSupp,b1.Keterangan,a1.kodeVls,a1.Kurs,a1.Tipe' +
        'Bayar,b1.Disc,b1.DiscRP'
      
        ',H.TotDiskon, H.TotDPP, H.TotPPN, H.TotNet,a.Harga,a.HrgNetto,a.' +
        'Qnt,a.DiscP,a.DiscTot,b1.hari,b1.handling,b1.NoUrut,b.Nosat,b1.F' +
        'akturSupp'
      
        ',b.Urut,b.isi,c.namaSupp,c.Alamat1 alamat,a1.PPN,b1.IsCetak,Case' +
        ' when b3.Qnt Is null Then 0 else (Isnull(b3.Qnt,0))end Qsisa,B3.' +
        'Satuan satSisa,d.Barcode Bar'
      'From DBPOdet a'
      'Left Outer Join dbPO a1 On a1.NoBukti=a.noBukti'
      ...
      'Left Outer Join dbBeli b1 On b1.NoBukti=b.NoBukti'
        ...
        'eliDet group by NoPO,KodeBrg,Satuan)b3 on b3.NoPO=a.NoBukti and ' +
        'b3.KodeBrg=a.KodeBrg '
      'Left Outer Join dbSupplier c on c.KodeSupp=a1.KodeSupp'
      'left outer join dbBarang d on d.KodeBrg=a.KodeBrg'
      'Left Outer Join vwMasterBeli H on H.NoBukti=b1.NoBukti'
      'where a.NoBukti=@NoPO and Isnull(b.Qnt,0)<>0'
      'order by a.Urut')
    Left = 2
    Top = 90
  end
