object FrBeli: TFrBeli
  ...
  Width = 833
  Height = 651
  Caption = 'Transaksi Pembelian Gudang'
  Color = clBtnFace
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'A.KodeExp, B.URUT, B.KODEBRG,case when isnull(NamaBarang,'#39#39') ='#39#39 +
        '    then Br.NAMABRG else NamaBarang end namabrg--, Br.NAMABRG'
      ', Br.NFix, B.QNT, B.NOSAT, B.SATUAN, B.ISI,'
      
        'B.HARGA, B.DISCP, B.DISCTOT, B.BYANGKUT, B.HRGNETTO, B.NDISKON, ' +
        'B.SUBTOTAL, '
      'B.NDPP, B.NPPN, B.NNET, B.NoPO, B.UrutPO, '
      'B.HPP, B.KodeGdg,'
      'B.QntTerima, B.Qnt1Terima, B.Qnt2Terima,nospk'
      'from DBBELI A'
