object FrBeliNota: TFrBeliNota
  Left = 263
  Top = 108
  Width = 1374
  Height = 676
  Caption = 'Transaksi Penerimaan(ACC.)'
  Color = clBtnFace
  ...
  object Panel3: TPanel
    ...
    object UbahBrg: TButton
      Left = 272
      Top = 56
      Width = 105
      Height = 25
      Caption = 'Ubah Kode Brg'
      TabOrder = 12
      Visible = False
    end
  end
    ...
    object dxPageControl1: TdxPageControl
      ...
      object dxTabSheet1: TdxTabSheet
        ...
        object dxDBGrid1: TdxDBGrid
          ...
          object dxDBGrid1NoPO: TdxDBGridColumn
            Caption = 'No. PO'
            Visible = False
            Width = 110
            BandIndex = 0
          ...
          object dxDBGrid1DiscTot2: TdxDBGridColumn
            Caption = 'Diskon 2'
            HeaderAlignment = taRightJustify
            Visible = False
            Width = 90
          ...
          object dxDBGrid1HrgNetto: TdxDBGridColumn
            Caption = 'Harga Netto'
            HeaderAlignment = taRightJustify
            Visible = False
            Width = 90
      ...
      object dxTabSheet2: TdxTabSheet
        ...
        object dxDBGrid2: TdxDBGrid
          ...
          object dxDBGrid2Kodebiaya: TdxDBGridMaskColumn
            Caption = 'Kode biaya'
            Width = 109
            BandIndex = 0
            RowIndex = 0
          ...
          object dxDBGrid2Nilai: TdxDBGridMaskColumn
            Width = 106
            BandIndex = 0
            RowIndex = 0
            FieldName = 'Nilai'
            SummaryFooterType = cstSum
            SummaryFooterField = 'Nilai'
            SummaryFooterFormat = ',0.00'
          end
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
      'select '#9'@NoBukti='#39'SJY/LPB/0113/0002'#39
      ''
      ...
      '        C.Alamat1+Char(13)+C.Alamat2+Char(13)+C.kota Alamat,'
        ...
        #9'B.KodeGdg, F.Nama, A.Handling/*, A.KodeExp, G.NamaExp*/, A.Kete' +
        'rangan, A.FakturSupp,'
      
        #9'A.KodeVls, D.NamaVls, A.Kurs, A.PPN, A.TipeBayar, A.Hari, A.Tip' +
        'eDisc, A.Disc, A.DiscRp,'
      
        #9'B.Urut, B.KodeBrg, case when e.Proses =1 then b.NamaBarang else' +
        '  E.NamaBrg end namabrg,/*E.NamaBrg,*/ B.Satuan, B.Qnt, B.NoSat,' +
        ' B.Isi, B.Harga, b.HrgNetto, B.DiscP, B.DiscTot,'
      #9'B.BYAngkut Beban,'
      #9'b.NoPO,b.UrutPO,'
      '        H.TotDiskon, H.TotDPP, H.TotPPN, H.TotNet, H.TotPPH,'
        ...
        ' end TotalPPh,'
      '        B.Discp2,B.Discp3,B.Discp4,B.Discp5,ppnp'
      'From dbBeli A'
  ...
  object DSPBIAYA: TDataSource
    DataSet = QuPBIAYA
    Left = 314
    Top = 304
  end
  object QuPBIAYA: TADOQuery
    Connection = DM.MyStock
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'declare @NoBukti varchar(30)'
      'select '#9'@NoBukti='#39'SJY/0113/INV/0001'#39
      'Select  a.*,(Nilai * Kurs)NilaiRp  from dbPBiaya a'
      'where NoBuktiInv=@NoBukti'
      'order by a.KodeBiaya'
      '')
    Left = 342
    Top = 304
    object QuPBIAYAKodebiaya: TStringField
      FieldName = 'Kodebiaya'
      Size = 15
    end
    object QuPBIAYAKeterangan: TStringField
      FieldName = 'Keterangan'
      Size = 200
    end
    object QuPBIAYANilai: TBCDField
      FieldName = 'Nilai'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    end
    object QuPBIAYAKodeVls: TStringField
      FieldName = 'KodeVls'
      Size = 15
    end
    object QuPBIAYAKurs: TBCDField
      FieldName = 'Kurs'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    end
    object QuPBIAYANoBuktiInv: TStringField
      FieldName = 'NoBuktiInv'
      Size = 30
    end
    object QuPBIAYANilaiRp: TBCDField
      FieldName = 'NilaiRp'
      ReadOnly = True
      DisplayFormat = ',0.00'
      Precision = 32
    end
    object QuPBIAYAUrut: TIntegerField
      FieldName = 'Urut'
    end
  end
  object SP_PBiaya: TADOStoredProc
    Connection = DM.MyStock
    ProcedureName = 'sp_PBiaya;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
