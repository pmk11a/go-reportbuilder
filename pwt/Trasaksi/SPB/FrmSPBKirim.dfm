object FrSPBKirim: TFrSPBKirim
  Left = 196
  Top = 112
  BorderStyle = bsDialog
  Caption = 'Detail Surat Pengantar Barang [Data Nomor Roll / Palllet]'
  ClientHeight = 508
  ClientWidth = 964
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object dxDBGrid1: TdxDBGrid
      ...
      OptionsDB = [edgoCanAppend, edgoCanNavigation, edgoLoadAllRecords, edgoUseBookmarks]
      ...
      object dxDBGrid1NOLOT: TdxDBGridMaskColumn
      ...
      object dxDBGrid1NoPallet: TdxDBGridMaskColumn
        Caption = 'Qnt'
        HeaderAlignment = taCenter
        BandIndex = 0
        RowIndex = 0
      ...
      object dxDBGrid1NOROLL: TdxDBGridMaskColumn
        Caption = 'No. Roll'
        HeaderAlignment = taCenter
        Visible = False
        BandIndex = 0
  ...
  object Sp_Beli: TADOStoredProc
    ...
    ProcedureName = 'Sp_SPBLampiran;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
        ...
        '       noroll kodebrg,f.Namabrg,A.Sat_1,A.Sat_2,A.Qnt,A.Qnt2,A.N' +
        'osat,A.ISI, A.Keterangan'
      '       ,NoSO,b1.KodeCustSupp'
      ...
      '                      from dbSPBDet x, dbbarang y'
        ...
        '                      where x.kodebrg=y.Kodebrg) b2 on B2.nobukt' +
        'i=A.NoSPB and b2.urut=a.UrutSPB'
      
        'left outer join dbSPBDet b on b.NoBukti =a.NoSPB and b.Urut=a.Ur' +
        'utSPB'
      'left outer join dbSPB b1 on b1.NoBukti =b.NoBukti'
      
        'left outer join DBHASILPRDDET c on c.NOBUKTI =b.NoSPP and c.urut' +
        ' =b.UrutSPP'
      'left outer join DBSPK d on d.NOBUKTI =c.NoSPK'
      'left outer join DBBARANG f on f.KODEBRG =a.NOROLL'
      'Where A.NoSPB=:0 and A.UrutSPB=:1'
      'Order by A.Urut')
    Left = 107
    Top = 82
    ...
    object QuBeliNOENQDET: TStringField
      FieldName = 'NOENQDET'
      ReadOnly = True
      Size = 30
    end
    object QuBeliUrutENQ: TIntegerField
      FieldName = 'UrutENQ'
      ReadOnly = True
    end
    object QuBeliNoPallet: TStringField
      FieldName = 'NoPallet'
      Size = 15
    end
    object QuBeliNOROLL: TStringField
      FieldName = 'NOROLL'
      Size = 15
    end
    object QuBeliNOLOT: TStringField
      FieldName = 'NOLOT'
      Size = 15
    end
