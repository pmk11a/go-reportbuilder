object FrMainHasilPPesan: TFrMainHasilPPesan
  Left = 242
  Top = 170
  Width = 941
  Height = 479
  ...
  object QuMaster: TADOQuery
    ...
    SQL.Strings = (
      ...
      'Select  *,'
        ...
        'nd=A.MaxOL then 0'
      '                 else 1'
      '            end As Bit) NeedOtorisasi From  dbHasilPrd A'
      
        'where year(Tanggal)=@Tahun and month(Tanggal)=@Bulan and A.IsPes' +
        'an = 1'
      'order by NoBukti'
      ''
      ''
