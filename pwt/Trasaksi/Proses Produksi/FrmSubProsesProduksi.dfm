object FrSubProsesProduksi: TFrSubProsesProduksi
  Left = 474
  Top = 356
  ...
  object JenisPesanan: TLabel
    Left = 124
    Top = 165
    Width = 3
    Height = 13
  end
  object NamaCustomer: TLabel
    Left = 121
    Top = 141
    Width = 3
    Height = 13
  ...
  object QuView: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
      'select distinct a.NOBUKTI ,c.urut ,c.KODEMSN ,d.Ket from DBSPK a'
      'left outer join DBSPKDET b on b.NOBUKTI =a.NOBUKTI '
      'left outer join DBJADWALPRD c on c.NOSPK =a.NOBUKTI '
      'left outer join DBMesin d on d.KodeMsn =c.KODEMSN'
