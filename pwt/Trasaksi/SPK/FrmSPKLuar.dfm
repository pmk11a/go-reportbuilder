object FrSPKLuar: TFrSPKLuar
  Left = 143
  Top = 100
  Width = 800
  Height = 630
  Caption = 'Transaksi SPK Luar'
  Color = clBtnFace
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'Select '#9'B.urut,A.NoBukti, A.NoBatch, A.TglExpired, A.tanggal, A.' +
        'NoUrut,'
      ...
      'A.KodeBOM'
      'From dbSPKLuar A'
      'Left Outer join dbSPKLuarDet B on B.NoBukti=a.NoBukti'
