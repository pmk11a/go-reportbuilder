object FrRBeliGdg: TFrRBeliGdg
  Left = 352
  Top = 20
  Width = 831
  Height = 645
  Caption = 'Transaksi Retur Pembelian Gudang'
  Color = clBtnFace
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      '        C.Alamat1+Char(13)+C.Alamat2+Char(13)+C.kota Alamat,'
        ...
        '        B.URUT, B.KODEBRG, E.NamaBrg, B.QNT, B.NOSAT, B.SATUAN, ' +
        'B.ISI, B.HARGA, B.DISCP, B.DISCTOT,'
      '        B.BYANGKUT, B.NOPBL, B.URUTPBL, B.Qnt2, B.Qnt1, B.HPP,'
      
        '        B.HRGNETTO, B.NDISKON, B.SUBTOTAL, B.NDPP, B.NPPN, B.NNE' +
        'T,'
      '        E.NFix'
      'From dbRBeli A'
    ...
    object QuBeliNILAIPOT: TBCDField
      FieldName = 'NILAIPOT'
      Precision = 18
      Size = 2
    end
    object QuBeliNILAIDPP: TBCDField
      FieldName = 'NILAIDPP'
      Precision = 18
      Size = 2
    end
    object QuBeliNILAIPPN: TBCDField
      FieldName = 'NILAIPPN'
      Precision = 18
      Size = 2
    end
    object QuBeliNILAINET: TBCDField
      FieldName = 'NILAINET'
      Precision = 18
      Size = 2
    end
  ...
  object Sp_Beli: TADOStoredProc
    Connection = DM.MyStock
    ProcedureName = 'sp_RBeliGudang;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object Sp_Rbeli: TADOStoredProc
    Connection = DM.MyStock
    ProcedureName = 'Sp_RBeli;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
