object FrBeli: TFrBeli
  ...
  object Panel2: TPanel
    ...
    object dxDBGrid1: TdxDBGrid
      ...
      object dxDBGrid1NamaTipeTrans: TdxDBGridMaskColumn
        Caption = 'Nama Tipe'
        HeaderAlignment = taCenter
        Width = 150
        BandIndex = 0
        RowIndex = 0
        FieldName = 'NamaTipeTrans'
      end
      ...
      object dxDBGrid1NNet: TdxDBGridMaskColumn
        ...
        FieldName = 'NNet'
        SummaryFooterType = cstSum
        SummaryFooterField = 'NNet'
        SummaryFooterFormat = ',0.00'
      end
      object dxDBGrid1Perk_Persediaan: TdxDBGridMaskColumn
        Caption = 'Persediaan'
        HeaderAlignment = taCenter
        Width = 150
        BandIndex = 0
      ...
      object dxDBGrid1Perk_PPn: TdxDBGridMaskColumn
        Caption = 'PPn'
        HeaderAlignment = taCenter
        Width = 150
        BandIndex = 0
      ...
      object dxDBGrid1Perk_HutPiut: TdxDBGridMaskColumn
        Caption = 'Hutang'
        HeaderAlignment = taCenter
        Width = 150
        BandIndex = 0
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
      'select '#9'@Bulan=:0, @Tahun=:1'
      ''
      
        'Select '#9'A.NoBukti, A.KodesubTipe,A.PPn, B.Nama Keterangan, A.Qnt' +
        ', A.Rp,  d.Keterangan NamaPersediaan, e.Keterangan NamaPPN, f.Ke' +
        'terangan NamaHutPiut,'
      '       d.Keterangan+'#39' ('#39'+d.Perkiraan+'#39')'#39' As Perk_Persediaan,'
      '       e.Keterangan+'#39' ('#39'+e.Perkiraan+'#39')'#39' As Perk_PPn,'
      
        '       f.Keterangan+'#39' ('#39'+f.Perkiraan+'#39')'#39' As Perk_HutPiut, A.Urut' +
        ','
      
        '       A.NPPn,A.NDPP, A.NNet, A.Tanggal, A.KodeCustSupp, g.NamaC' +
        'ustSupp, g.ALamat,'
      '       c.Nama NamaTipeTrans, c.KodeTipe'
      'From dbPembelian A'
      
        '     left Outer Join dbSubTipeTrans b on b.kodesubtipe=a.Kodesub' +
        'Tipe and b.kodetipe=a.kodetipe'
      '     left Outer join dbTipeTrans c on c.Kodetipe=b.kodetipe '
      
        '     left Outer join dbPerkiraan d on d.perkiraan=b.Persediaan a' +
        'nd d.tipe=1'
      
        '     left Outer join dbPerkiraan e on e.perkiraan=b.PPn and e.ti' +
        'pe=1'
      
        '     left Outer join dbPerkiraan f on f.perkiraan=b.HutPiut and ' +
        'f.tipe=1'
      
        '     Left Outer Join vwBrowsSupp g on g.KodecustSupp=a.KodeCustS' +
        'upp'
    ...
    object QuBeliKodesubTipe: TStringField
      FieldName = 'KodesubTipe'
      Size = 15
    end
    ...
    object QuBeliRp: TBCDField
      FieldName = 'Rp'
      DisplayFormat = ',0.##'
      Precision = 18
      Size = 2
    end
    object QuBeliNamaPersediaan: TStringField
      FieldName = 'NamaPersediaan'
      Size = 8000
    end
    object QuBeliNamaPPN: TStringField
      FieldName = 'NamaPPN'
      Size = 8000
    end
    object QuBeliNamaHutPiut: TStringField
      FieldName = 'NamaHutPiut'
      Size = 8000
    end
    object QuBeliPerk_Persediaan: TStringField
      FieldName = 'Perk_Persediaan'
      ReadOnly = True
      Size = 8000
    end
    object QuBeliPerk_PPn: TStringField
      FieldName = 'Perk_PPn'
      ReadOnly = True
      Size = 8000
    end
    object QuBeliPerk_HutPiut: TStringField
      FieldName = 'Perk_HutPiut'
      ReadOnly = True
      Size = 8000
    end
    ...
    object QuBeliNamaTipeTrans: TStringField
      FieldName = 'NamaTipeTrans'
      Size = 50
    end
    object QuBeliKodeTipe: TStringField
      FieldName = 'KodeTipe'
      Size = 15
    end
  end
