object FrMainKasBank: TFrMainKasBank
  Left = 350
  Top = 64
  Width = 958
  Height = 479
  Caption = 'Jurnal Kas Bank'
  Color = 16773589
  ...
  object cxGrid1: TcxGrid
    ...
    object tvMaster: TcxGridDBTableView
      ...
      object tvMasterUsetOto1: TcxGridDBColumn
      ...
      object tvMasterOto2: TcxGridDBColumn
      ...
      object tvMasterUser5: TcxGridDBColumn
  ...
  object QuView: TADOQuery
    ...
    SQL.Strings = (
      ...
      'left outer join dbTransaksi c on c.NoBukti=a.NoBukti'
        ...
        'a.nobukti,9,3) in ('#39'BKK'#39','#39'BKM'#39','#39'BBK'#39','#39'BBM'#39')'
  ...
  object QuMaster: TADOQuery
    ...
    SQL.Strings = (
      ...
      '        sum((B.Debet+B.Kredit)*B.Kurs) TotalRp,'
        ...
        'r4, A.TglOto4,'
      #9'A.IsOtorisasi5, A.OtoUser5, A.TglOto5 , sum(MaxOL) maxoto,'
      #9'Case when A.IsOtorisasi1=1 then 1 else 0 end+'
      ...
      '        and B.TipeTrans in ('#39'BBK'#39','#39'BBM'#39','#39'BKK'#39','#39'BKM'#39')'
    ...
    object QuMastermaxoto: TIntegerField
      FieldName = 'maxoto'
      ReadOnly = True
    end
    object QuMasterjmloto: TIntegerField
      FieldName = 'jmloto'
      ReadOnly = True
    end
  end
