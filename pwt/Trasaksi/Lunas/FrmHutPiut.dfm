object FrHutPiut: TFrHutPiut
  ...
  object Panel2: TPanel
    ...
    object dxDBhutPiut: TdxDBGrid
      ...
      ParentFont = False
      TabOrder = 1
      OnClick = dxDBhutPiutClick
      OnDblClick = dxDBhutPiutDblClick
      OnKeyDown = dxDBhutPiutKeyDown
      OnKeyUp = dxDBhutPiutKeyDown
      OnMouseDown = dxDBhutPiutMouseDown
      OnMouseUp = dxDBhutPiutMouseDown
      BandFont.Charset = ANSI_CHARSET
      BandFont.Color = clWindowText
      BandFont.Height = -13
      BandFont.Name = 'Tahoma'
      BandFont.Style = []
      DataSource = FrLunas.DSHutPiut
