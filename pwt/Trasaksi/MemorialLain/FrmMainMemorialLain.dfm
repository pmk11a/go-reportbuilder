object FrMainMemorialLain: TFrMainMemorialLain
  Left = 126
  Top = 225
  Width = 1283
  Height = 479
  Caption = 'Jurnal Memorial dan Jurnal Koreksi Stock'
  Color = 16773589
  ...
  object QuMaster: TADOQuery
    ...
    SQL.Strings = (
      ...
      'where year(A.Tanggal)=@Tahun and month(A.Tanggal)=@Bulan'
        ...
        '        and B.TipeTrans in ('#39'BMM'#39','#39'BJK'#39','#39'PBL'#39','#39'PJL'#39')     and isn' +
        'ull(flagtipe,0)=1'
