object FrMainHasilP: TFrMainHasilP
  Left = -8
  Top = -8
  Width = 1320
  Height = 784
  ...
  object cxGrid1: TcxGrid
    ...
    object tvDetail: TcxGridDBTableView
      ...
      object tvDetailNoSO: TcxGridDBColumn
  ...
  object QuMaster: TADOQuery
    ...
    SQL.Strings = (
      ...
      '                 else 1'
        ...
        '            end As Bit) NeedOtorisasi, case when NoJurnal <>'#39#39' t' +
        'hen 1 else 0 end adajurnal  From  dbHasilPrd A'
    ...
    object QuMasteradajurnal: TIntegerField
      FieldName = 'adajurnal'
      ReadOnly = True
    end
  end
  ...
  object QuSPP: TADOQuery
    ...
    object QuSPPurutso: TIntegerField
      FieldName = 'urutso'
    end
  end
