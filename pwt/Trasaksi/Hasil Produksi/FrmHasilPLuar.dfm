object FrHasilPLuar: TFrHasilPLuar
  Left = 151
  Top = 62
  Width = 833
  Height = 651
  Caption = 'Transaksi Hasil Produksi Luar'
  Color = clBtnFace
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      'B.KodeGdg,NoSPK,c.Nama'
      'from DBHasilPrdLuar A'
      'left outer join DBHasilPrdLuarDET B on B.NOBUKTI=A.NOBUKTI'
  ...
  object Sp_Beli: TADOStoredProc
    Connection = DM.MyStock
    ProcedureName = 'Sp_HasilPrdLuar;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
