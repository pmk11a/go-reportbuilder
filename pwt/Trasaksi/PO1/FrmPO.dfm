object FrPO: TFrPO
  ...
  Width = 947
  Height = 646
  Caption = 'Transaksi Purchase Order (PO)'
  Color = clBtnFace
    ...
    object dxPageControl1: TdxPageControl
      ...
      object dxTabSheet1: TdxTabSheet
        ...
        object dxDBGrid1: TdxDBGrid
          ...
          object dxDBGrid1Tolerate: TdxDBGridMaskColumn
            Caption = 'Toleransi'
            HeaderAlignment = taRightJustify
            Width = 70
            BandIndex = 0
          ...
          object dxDBGrid1NoPPL: TdxDBGridMaskColumn
            Caption = 'No. PR'
            Width = 140
            BandIndex = 0
            RowIndex = 0
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      '        C.Alamat1+Char(13)+C.Alamat2+Char(13)+C.kota Alamat,'
        ...
        #9'A.KodeVls, D.NamaVls, A.Kurs, A.PPN, A.TipeBayar, A.Hari, A.Dis' +
        'c,'
      ...
      '        x.TotalX,dbo.terbilang(x.totalx) Terbilang'
      'From dbPO A'
  ...
  object QuReport: TADOQuery
    ...
    SQL.Strings = (
      'declare @NoBukti varchar(30)'
      ''
      'select '#9'@NoBukti='#39'xxx/PO/0113/0003'#39
      ''
      
        'select A.KodeBrg,B.NAMABRG,A.Tanggal TglKrm,A.Qnt QntKrm,D.HARGA' +
        ' - D.DISCTOT HrgKrm,'
      '(D.harga - D.DISCTOT) * A.Qnt TotalDetKirim,'
      'Dbo.terbilang(ter.TerBilang) terbilang,'
      ...
      'Left outer join DBPO C on A.NoBukti = C.NOBUKTI'
        ...
        'ga,Sum(isnull(Disctot,0)) Disctot from'
      ...
      'where'#9'ter.NoBukti=@NoBukti'
      'order by A.KOdeBrg'
      ''
      ''
      
        '/*Select A.Nobukti,f.tanggal,B.NamaBrg,A.Qnt,A.Satuan,A.Harga,C.' +
        'NamaSupp,C.Alamat,C.Kota,C.Telpon,'
      '       F.Hari,A.ket,'
    ...
    Left = 114
    Top = 266
    object QuReportKodeBrg: TStringField
      FieldName = 'KodeBrg'
      Size = 25
    end
    object QuReportNAMABRG: TStringField
      FieldName = 'NAMABRG'
      Size = 100
    end
    object QuReportTglKrm: TDateTimeField
      FieldName = 'TglKrm'
    end
    object QuReportQntKrm: TBCDField
      FieldName = 'QntKrm'
      Precision = 18
      Size = 2
    end
    object QuReportHrgKrm: TBCDField
      FieldName = 'HrgKrm'
      ReadOnly = True
      Precision = 32
      Size = 2
    end
    object QuReportTotalDetKirim: TBCDField
      FieldName = 'TotalDetKirim'
      ReadOnly = True
      Precision = 32
    end
    object QuReportterbilang: TStringField
      FieldName = 'terbilang'
      ReadOnly = True
      Size = 250
    end
    object QuReportAlamat: TStringField
      FieldName = 'Alamat'
      ReadOnly = True
      Size = 302
    end
    object QuReportNamaCustSupp: TStringField
      FieldName = 'NamaCustSupp'
      Size = 100
    end
    object QuReportTotPPNRp: TFloatField
      FieldName = 'TotPPNRp'
      ReadOnly = True
    end
    object QuReportTotDiskon: TFloatField
      FieldName = 'TotDiskon'
      ReadOnly = True
    end
  end
  ...
  object qukirim: TADOQuery
    ...
    object qukirimQukirimNoBukti: TStringField
      FieldName = 'NoBukti'
    end
    object qukirimQukirimKodeBrg: TStringField
      FieldName = 'KodeBrg'
      Size = 25
    end
    ...
    object qukirimQukirimNoSat: TWordField
      FieldName = 'NoSat'
    end
    ...
    object qukirimQukirimQnt: TBCDField
      FieldName = 'Qnt'
      ReadOnly = True
      Precision = 32
      Size = 2
