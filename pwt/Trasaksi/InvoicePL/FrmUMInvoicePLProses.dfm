object FrUMInvoicePLProses: TFrUMInvoicePLProses
  Left = 332
  Top = 196
  ...
  object QuSO: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
      'Select A.Nobukti, A.Tanggal,A.NOBUKTI Noso, A.TANGGAL TGLSO,'
      '       A.nobukti KeyUrut ,A.KodeCust KodeCustSupp,A.FlagTipe'
      'From DBSO A'
      ...
      '                      from DBInvoiceUM x'
        ...
        '                           Left Outer Join dbInvoiceUMDet y on y' +
        '.nobukti=x.nobukti'
      ...
      'Group by A.Nobukti, A.Tanggal,A.KodeCust ,A.FlagTipe'
      'Order by A.NoBukti')
    Left = 187
    Top = 200
    ...
    object QuSOFlagTipe: TStringField
      FieldName = 'FlagTipe'
      Size = 1
    end
  end
