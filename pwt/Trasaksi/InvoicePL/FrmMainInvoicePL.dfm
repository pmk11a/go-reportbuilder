object FrMainInvoicePL: TFrMainInvoicePL
  Left = -4
  Top = -4
  Width = 1928
  Height = 892
  ...
  object dxPageControl1: TdxPageControl
    ...
    object dxTabSheet1: TdxTabSheet
      Caption = 'Surat Pengiriman Barang'
      object cxGrid4: TcxGrid
        ...
        object tvMaster4: TcxGridDBBandedTableView
          ...
          object tvMaster4NoBukti: TcxGridDBBandedColumn
            Caption = 'No. Bukti'
          ...
          object tvMaster4Tanggal: TcxGridDBBandedColumn
          ...
          object tvMaster4NoSC: TcxGridDBBandedColumn
            Caption = 'No. SPP'
          ...
          object tvMaster4TglSC: TcxGridDBBandedColumn
            Caption = 'Tanggal SPP'
          ...
          object tvMaster4TglKirim: TcxGridDBBandedColumn
          ...
          object tvMaster4IsClose: TcxGridDBBandedColumn
            Caption = 'Close ?'
    ...
    object dxTabSheet2: TdxTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object tvMaster3: TcxGridDBBandedTableView
          ...
          object tvMaster3DBBandedColumn4: TcxGridDBBandedColumn
            Caption = 'No Jurnal'
            DataBinding.FieldName = 'nojurnal'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          ...
          object tvMaster3DBBandedColumn5: TcxGridDBBandedColumn
            Caption = 'No Jurnal'
            DataBinding.FieldName = 'nojurnal'
            Position.BandIndex = -1
            Position.ColIndex = -1
        ...
        object tvDetail3: TcxGridDBBandedTableView
          ...
          object tvDetail3DBBandedColumn1: TcxGridDBBandedColumn
            Caption = 'No SO'
            DataBinding.FieldName = 'noso'
            Position.BandIndex = 0
            Position.ColIndex = 2
          ...
          object tvDetail3DBBandedColumn2: TcxGridDBBandedColumn
            Caption = 'No SPB'
            DataBinding.FieldName = 'NoSPB'
            Position.BandIndex = 0
            Position.ColIndex = 3
  ...
  object QuMasterInv: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
      'select @Tahun=2013, @Bulan=7'
      ''
      'select distinct A.NoBukti, A.NoUrut, A.Tanggal,'
      
        '        '#39#39'NoSPP,/* D.Tanggal*/ NULL TglSPP,'#39#39' NoSO,/*E.Tanggal*/' +
        'NULL TGLSO, A.KodeCustSupp, F.NAMACUSTSUPP NamaCustSupp, A.Consi' +
        'gnee, A.NotifyParty,'
        ...
        'A.ISLOKAL,'
      '        '#39#39' NoSPB, /*C.Tanggal*/ NULL TglSPB,'
      '        A.IsCetak, A.IDUser,'
      ...
      '           end As Bit) NeedOtorisasi'
        ...
        '        ,Isnull(A.IsBatal,0) Isbatal,A.userBatal,A.tglBatal ,a.n' +
        'ojurnal'
    ...
    object QuMasterInvTGLSO: TIntegerField
      FieldName = 'TGLSO'
      ReadOnly = True
    end
    ...
    object QuMasterInvTglSPB: TIntegerField
      FieldName = 'TglSPB'
      ReadOnly = True
    end
    ...
    object QuMasterInvIsbatal: TBooleanField
      FieldName = 'Isbatal'
      ReadOnly = True
    end
    object QuMasterInvuserBatal: TStringField
      FieldName = 'userBatal'
      Size = 15
    end
    object QuMasterInvtglBatal: TDateTimeField
      FieldName = 'tglBatal'
    end
    object QuMasterInvnojurnal: TStringField
      FieldName = 'nojurnal'
      Size = 30
    end
  end
  ...
  object QuDetail4: TADOQuery
    ...
    SQL.Strings = (
        ...
        'Select  A.NoBukti, A.Urut, A.NoSPP, A.UrutSPP, A.KodeBrg, A.Nama' +
        'brg,'
      
        '        A.QNT-isnull(H.QntRSPB,0) Qnt, A.QNT2-isnull(H.Qnt2RSPB,' +
        '0) QNT2, A.SAT_1, A.SAT_2, A.NOSAT, A.ISI, A.NetW, A.GrossW, A.H' +
        'PP, A.KodeGdg,'
      ...
      '                      from DBRSPBDet x'
        ...
        '=A.NoBukti and H.UrutSPB=A.Urut'
    ...
    object QuDetail4NOSAT: TIntegerField
      FieldName = 'NOSAT'
    end
  ...
  object QuMaster4: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        '/*Set @Periode=CAST(@Tahun as varchar(4))+Case when @Bulan<10 th' +
        'en '#39'0'#39' else '#39#39' end+CAST(@Bulan as varchar(2))'
      'Select  distinct  A.NoBukti,A.Tanggal,A.KodeCustSupp,C.TglKirim,'
      '              D.NOBUKTI'
      '        Noso,'
      '       D.Tanggal TglSO, B.NoSPP, C.Tanggal TglSPP,'
      '       m1.NamaCustSupp, A.IsClose'
      'From DBSPB A'
      
        '     Left Outer join (Select x.NoBukti, x.NoSPP, Sum(x.QNT-ISNUL' +
        'L(y.qnt,0)) Qnt, Sum(x.QNT2-ISNULL(y.Qnt2,0)) Qnt2'
      '                      from dbSPBDet x'
      
        '                           left Outer join (Select x.NoSPB, x.Ur' +
        'utSPB, Sum(x.QNT) Qnt, Sum(x.QNT2) Qnt2'
      '                                            From DBRSPBDet x'
      
        '                                            Group by x.NoSPB, x.' +
        'UrutSPB) y on y.NoSPB=x.NoBukti and y.UrutSPB=x.Urut'
      
        '                      group by x.NoBukti, x.NoSPP, y.NoSPB) B on' +
        ' B.NoBukti=A.NoBukti'
      
        '     Left Outer Join (Select x.NoBukti, x.Tanggal,y.NoSO, x.TglK' +
        'irim'
      '                      from DBSPP x'
        ...
        '                      Group by x.NoBukti, x.Tanggal,y.NoSO, x.Tg' +
        'lKirim) C On C.NoBukti=B.NoSPP'
      '     left outer join DBSO D on D.Nobukti=C.NoSO'
      
        '     left outer join vwBrowsCustomer E on E.Kodecust=A.KodeCustS' +
        'upp and E.Sales=D.KODESLS'
      '     left outer join dbInvoicePLDet F on F.NoSPB=A.NoBukti'
      
        '     Left Outer Join DbCustSupp M1 on A.KodeCustSupp=M1.KodeCust' +
        'supp'
      ...
      '                else 1'
      '           end As Bit)=0'
      '           and CAST(YEAR(A.Tanggal) as varchar(4))+'
      
        '           Case when month(A.Tanggal)<10 then '#39'0'#39' else '#39#39' end+CA' +
        'ST(month(A.Tanggal) as varchar(2))<=@Periode and'
      ' (     ((B.Qnt>0 or B.Qnt2>0) and F.NoSPB is null ) or'
      '( f.NoSPB is not  null and'
      'b.QNT =0)'
      ')'
      'order by A.NoBukti'
      '*/'
        ...
        'Select  distinct  b.Qnt ,b.Qnt2,qntspbinv , b.qntspb ,b.NoBukti,' +
        'A.NoBukti,A.Tanggal,A.KodeCustSupp,C.TglKirim,'
      '              D.NOBUKTI '
      '        Noso,'
      '       D.Tanggal TglSO, B.NoSPP, C.Tanggal TglSPP,'
      '       m1.NamaCustSupp, A.IsClose'
      'From DBSPB A'
        ...
        '     Left Outer join (Select x.NoBukti, x.NoSPP,SUM(x.qnt) qntsp' +
        'b, Sum(x.QNT-ISNULL(y.qnt,0)) Qnt, Sum(x.QNT2-ISNULL(y.Qnt2,0)) ' +
        'Qnt2'
      '                      from dbSPBDet x'
      ...
      '     left outer join dbInvoicePLDet F on F.NoSPB=A.NoBukti'
        ...
        '     left outer join (select NoSPB  ,SUM(QNT ) qntspbinv from db' +
        'InvoicePLDet group by NoSPB ) g on g.NoSPB=A.NoBukti'
      ...
      '/* (     ((B.Qnt>0 or B.Qnt2>0) and F.NoSPB is null ) or'
      '( f.NoSPB is not  null and'
      'b.QNT =0) and qntspbinv <ISNULL(qntspb ,0)'
      ')  qnt2 harus full dengan spb */'
      '(     ((B.Qnt>0 or B.Qnt2>0) and F.NoSPB is null ) '
      ' or '
      '( f.NoSPB is not  null and b.QNT2 =0/*-b.QNT =0*/'
      ') and qntspbinv <=ISNULL(qntspb ,0)'
      ')'
      'and year(a.tanggal)>=2018'
      'order by A.NoBukti')
    Left = 24
    Top = 256
    ...
    object QuMaster4TglKirim: TDateTimeField
      FieldName = 'TglKirim'
    end
    object QuMaster4Noso: TStringField
      FieldName = 'Noso'
      Size = 30
    end
    object QuMaster4TglSO: TDateTimeField
      FieldName = 'TglSO'
    end
    object QuMaster4NoSPP: TStringField
      FieldName = 'NoSPP'
      Size = 30
    end
    object QuMaster4TglSPP: TDateTimeField
      FieldName = 'TglSPP'
    end
    ...
    object QuMaster4IsClose: TBooleanField
      FieldName = 'IsClose'
    end
  end
