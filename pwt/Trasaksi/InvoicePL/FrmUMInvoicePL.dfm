object FrUMInvoicePL: TFrUMInvoicePL
  Left = 222
  Top = 20
  Width = 1000
  Height = 658
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      '       A.Valas,A.Kurs,A.IsLokal,Isnull(a.DP,0)DP,'
      ...
      '            Else '#39#39
        ...
        '     /*  Case when A.Valas='#39'IDR'#39' then K.TotDPPRp  else K.TotDPP ' +
        'end TotalDPP,'
      ...
      '       B.UrutTrans'
      'From dbInvoiceUM A'
      '     left outer join dbInvoiceUMDet B on B.NoBukti=A.NoBukti'
      ...
      '     Left Outer join vwRpDetUMInvoicePL K on K.nobukti=A.Nobukti'
    ...
    object QuBeliDiskon: TIntegerField
      FieldName = 'Diskon'
      ReadOnly = True
    end
