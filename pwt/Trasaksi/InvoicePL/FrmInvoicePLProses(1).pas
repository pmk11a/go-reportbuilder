...
begin
  ...
  begin
    ...
    SQL.Add('       A.Catatan, G.NoBukti Noso, G.Tanggal TglSO, F.NoBukti NoSPP, F.Tanggal TglSPP,Isnull(G.Discp2,0) Discp2, ');
    Sql.add('       Isnull(G.Discp3,0) Discp3,isnull(Discp4,0) Discp4,Isnull(Discp5,0) Discp5');
    ...
    SQL.Add('                             y.HARGA, y.DISCP1, y.DISCRP1, y.DISCTOT, x.KODEVLS, x.KURS, x.TIPEBAYAR, x.PPN, x.HARI, x.Disc,Y.Discp2,Discp3,Discp4,Discp5');
    SQL.Add('                      From dbSO x');
