object FrInvoicePLProses: TFrInvoicePLProses
  Left = 332
  Top = 196
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Proses Pembuatan Invoice'
  ClientHeight = 340
  ClientWidth = 636
  Color = clBtnFace
  ...
  object QuSO: TADOQuery
    ...
    SQL.Strings = (
      ...
      'Select A.Nobukti, A.Tanggal,G.NOBUKTI Noso, G.TANGGAL TGLSO,'
        ...
        '       A.nobukti KeyUrut ,ISnull(A.FlagTipe,0) FlagTipe,A.KodeCU' +
        'stSupp'
      'From DBSPB A'
      ...
      '                      From dbSPP x'
        ...
        '     Left Outer join (Select x.kodecust kodecustsupp,x.NoBukti,x' +
        '.Tanggal, y.Urut, x.NoPesanan, x.TglKirim, x.NoAlamatKirim,'
      ...
      'Where G.kodecustsupp=@nobukti and--G.NoBukti=@nobukti and'
      ...
      '      end >0'
        ...
        'Group by A.Nobukti, A.Tanggal, G.NOBUKTI, G.TANGGAL,A.FlagTipe,A' +
        '.KodeCUstSupp'
      'Order by A.NoBukti')
    Left = 187
    Top = 200
    ...
    object QuSOKodeCUstSupp: TStringField
