  ...
  object QuSO: TADOQuery
    ...
    SQL.Strings = (
      ...
      '                      From dbSPP x'
        ...
        '     Left Outer join (Select x.NoBukti,x.Tanggal, y.Urut, x.NoPe' +
        'sanan, x.TglKirim, x.NoAlamatKirim,'
      ...
      '           else 0'
      '      end >0'
      'Group by A.Nobukti, A.Tanggal, G.NOBUKTI, G.TANGGAL'
      'Order by A.NoBukti')
    Left = 187
    Top = 200
