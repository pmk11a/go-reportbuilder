...
uses
  ...
  frxExportRTF, frxExportBIFF, frxExportCSV;

type
  TSaveMethod = procedure (const FileName: String; ASaveAll: Boolean) of object;

  TFrMainInvoicePL = class(TForm)
    ...
    tvMaster4TglKirim: TcxGridDBBandedColumn;
    tvMaster4TglShip: TcxGridDBBandedColumn;
    tvMaster4NoSC: TcxGridDBBandedColumn;
    tvMaster4TglSC: TcxGridDBBandedColumn;
    tvMaster4NamaCustSupp: TcxGridDBBandedColumn;
    tvMaster4IsClose: TcxGridDBBandedColumn;
    ...
    QuMaster4TglKirim: TDateTimeField;
    QuMaster4Noso: TStringField;
    QuMaster4TglSO: TDateTimeField;
    QuMaster4NoSPP: TStringField;
    QuMaster4TglSPP: TDateTimeField;
    QuMaster4NamaCustSupp: TStringField;
    QuMaster4IsClose: TBooleanField;
    ...
    tvDetail3DBBandedColumn1: TcxGridDBBandedColumn;
    tvDetail3DBBandedColumn2: TcxGridDBBandedColumn;
    ...
    QuMasterInvTGLSO: TIntegerField;
    ...
    QuMasterInvTglSPB: TIntegerField;
    ...
    QuMasterInvIsbatal: TBooleanField;
    QuMasterInvuserBatal: TStringField;
    QuMasterInvtglBatal: TDateTimeField;
    tvMaster3DBBandedColumn4: TcxGridDBBandedColumn;
    QuMasterInvnojurnal: TStringField;
    tvMaster3DBBandedColumn5: TcxGridDBBandedColumn;
...
var
  FrMainInvoicePL: TFrMainInvoicePL;
  S: array[0..255] of char;

implementation

uses MyModul, Myprocedure, MyGlobal, FrmBrows, FrmSetForm, FrmInvoicePL, FrmNoBuktiInvoicePL,
  frmLogin, FrmInvoicePLProses;

{$R *.dfm}

procedure TFrMainInvoicePL.GetData(bulan,tahun:integer);
begin
  with QuMasterInv do
  begin
    Close;
...
procedure TFrMainInvoicePL.Save(ADefaultExt, AFilter, AFileName: String; AMethod: TSaveMethod);
begin
  with SaveDialog do
  begin
...
procedure TFrMainInvoicePL.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  if (Application.MessageBox('Anda yakin keluar modul ?','Keluar - Modul',
           MB_YESNO or MB_ICONSTOP + MB_DEFBUTTON2)=IDYES)then
  begin
    if Application.FindComponent('FrInvoicePL')<>nil then
    begin
       MessageDlg('Modul '+FrInvoicePL.Caption+' belum ditutup !',mtWarning,[mbok],0);
       Action := caNone
    end
    else Action:=caFree;
  end
...
procedure TFrMainInvoicePL.FormDestroy(Sender: TObject);
begin
  FrMainInvoicePL:=nil;
end;

procedure TFrMainInvoicePL.FormShow(Sender: TObject);
begin
...
procedure TFrMainInvoicePL.ToolButton10Click(Sender: TObject);
begin
  GetData(StrToInt(PeriodBln),StrToInt(PeriodThn));
end;

procedure TFrMainInvoicePL.ToolButton9Click(Sender: TObject);
begin
   Close;
end;

procedure TFrMainInvoicePL.ProsesPembuatanInvoice;
var i:Integer;
begin
   Application.CreateForm(TFrInvoicePLProses,FrInvoicePLProses);
   FrInvoicePLProses.mNOSO_SJProses:=QuMaster4Noso.AsString;
   FrInvoicePLProses.mNOSOKodecust_SJProses:=QuMaster4KodeCustSupp.AsString;
   FrInvoicePLProses.ShowModal;
   if FrInvoicePLProses.ModalResult=mrOK then
   begin
     if Assigned(FrInvoicePL) then
       begin
        FrInvoicePL.Show;
       end
     else
     begin
       gTempNoBukti := FrInvoicePLProses.NoBukti;
       gTempNoBuktiSO:=FrInvoicePLProses.mNOSO_SJProses;
       ModalKoreksi:=True;
       Application.CreateForm(TFrInvoicePL,FrInvoicePL);
       CekOtoritasMenu(IDUser,tag,FrInvoicePL.Istambah,FrInvoicePL.Ishapus,
                   FrInvoicePL.Iskoreksi, FrInvoicePL.isCetak, FrInvoicePL.isExcel);
       FrInvoicePL.Show;
     end;
   end;
end;

procedure TFrMainInvoicePL.ToolButton1Click(Sender: TObject);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          CekOtoritasMenu(IDUser,tag,FrInvoicePL.Istambah,FrInvoicePL.Ishapus,
                          FrInvoicePL.Iskoreksi, FrInvoicePL.isCetak, FrInvoicePL.isExcel);
          FrInvoicePL.xModalKoreksi:=ModalKoreksi;
          FrInvoicePL.Show;
        end;
      end;
    end
...
procedure TFrMainInvoicePL.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrMainInvoicePL.ToolButton2Click(Sender: TObject);
begin
...
procedure TFrMainInvoicePL.tvMaster3FocusedRecordChanged(
...
procedure TFrMainInvoicePL.tvMaster4FocusedRecordChanged(
  Sender: TcxCustomGridTableView; APrevFocusedRecord,
  AFocusedRecord: TcxCustomGridRecord;
  ANewItemRecordFocusingChanged: Boolean);
begin
...
procedure TFrMainInvoicePL.ToolButton4Click(Sender: TObject);
begin
...
procedure TFrMainInvoicePL.ToolButton12Click(Sender: TObject);
begin
    BM := QuMasterInv.GetBookmark;
    {frLogin := TFrLogin.Create(Self);
    frLogin.Label2.Caption :='Otorisasi';
    ...
    begin
      ...
      BatalOtorisasi('DBInvoicePL',MenuINV,IDUser,'',QuMasterInvNoBukti.Value);
...
procedure TFrMainInvoicePL.frxReport1GetValue(const VarName: String;
  var Value: Variant);
begin
...
procedure TFrMainInvoicePL.ToolButton15Click(Sender: TObject);
begin
...
procedure TFrMainInvoicePL.tvMaster3CellClick(
...
procedure TFrMainInvoicePL.tvMaster3CustomDrawCell(
...
procedure TFrMainInvoicePL.INVOICE1Click(Sender: TObject);
var xNet : Real;
begin
   if IsCetak then
   begin
...
procedure TFrMainInvoicePL.KWITANSI1Click(Sender: TObject);
var xNet : Real;
begin
   if IsCetak then
   begin
      begin
        ...
        begin
          close;
          sql.Clear;
          sql.Add('Exec cetakInvoicePenjualanK '+QuotedStr(QuMasterInvNoBukti.AsString));
          Prepared;
          open;
        end;
        QuUpdatedbBeli.DisableControls;
...
procedure TFrMainInvoicePL.ANDATERIMA1Click(Sender: TObject);
var xNet : Real;
begin
   if IsCetak then
   begin
