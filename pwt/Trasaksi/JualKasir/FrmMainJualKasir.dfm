object FrMainJualKasir: TFrMainJualKasir
  Left = 240
  Top = 190
  Width = 992
  Height = 530
    ...
    object dxTabSheet1: TdxTabSheet
      ...
      object cxGrid2: TcxGrid
        ...
        object tvPO: TcxGridDBTableView
          DataController.DataSource = dsQuOrderM
          ...
          OnFocusedRecordChanged = tvPOFocusedRecordChanged
          ...
          object tvPONOBUKTI: TcxGridDBColumn
            Caption = 'No. Bukti'
            DataBinding.FieldName = 'NOBUKTI'
            Width = 157
          end
          object tvPOTANGGAL: TcxGridDBColumn
            Caption = 'Tanggal Order'
            DataBinding.FieldName = 'TANGGAL'
            Width = 161
          end
        end
        object VwDetail: TcxGridDBTableView
          DataController.DataSource = dsQuOrderD
          ...
          OptionsView.GroupByBox = False
          OptionsView.Indicator = True
          object VwDetailKodeBrg: TcxGridDBColumn
            Caption = 'Kode Brg'
            DataBinding.FieldName = 'KodeBrg'
          end
          object VwDetailNamaBrg: TcxGridDBColumn
            Caption = 'Nama'
            DataBinding.FieldName = 'NamaBrg'
            Width = 200
          end
          object VwDetailHARGA: TcxGridDBColumn
            Caption = 'Harga'
            DataBinding.FieldName = 'HARGA'
          end
          object VwDetailQNT: TcxGridDBColumn
            Caption = 'Qnt'
            DataBinding.FieldName = 'QNT'
          end
          object VwDetailSATUAN: TcxGridDBColumn
            Caption = 'SAT'
            DataBinding.FieldName = 'SATUAN'
            Width = 40
          end
          object VwDetailhrgnetto: TcxGridDBColumn
            Caption = 'Harga Netto'
            DataBinding.FieldName = 'hrgnetto'
            Visible = False
          end
          object VwDetailsubtotal: TcxGridDBColumn
            Caption = 'Total'
            DataBinding.FieldName = 'subtotal'
          end
          object VwDetailTglBatal: TcxGridDBColumn
            DataBinding.FieldName = 'TglBatal'
            Visible = False
          end
          object VwDetailisGratis: TcxGridDBColumn
            DataBinding.FieldName = 'isGratis'
            Visible = False
          end
          object VwDetailKeterangan: TcxGridDBColumn
            DataBinding.FieldName = 'Keterangan'
            Visible = False
          end
          object VwDetailIsSelesai: TcxGridDBColumn
            DataBinding.FieldName = 'IsSelesai'
            PropertiesClassName = 'TcxCheckBoxProperties'
            Properties.DisplayUnchecked = 'False'
            Visible = False
          end
          object VwDetailIsKirim: TcxGridDBColumn
            DataBinding.FieldName = 'IsKirim'
            Visible = False
          end
          object VwDetailTakeIn: TcxGridDBColumn
            DataBinding.FieldName = 'TakeIn'
            PropertiesClassName = 'TcxCheckBoxProperties'
            Properties.DisplayUnchecked = 'False'
            Visible = False
          end
          object VwDetailTakeout: TcxGridDBColumn
            Caption = 'Take Out'
            DataBinding.FieldName = 'Takeout'
            PropertiesClassName = 'TcxCheckBoxProperties'
            Properties.DisplayUnchecked = 'False'
            Width = 80
          end
  ...
  object QuMaster: TADOQuery
    ...
    object QuMasterNoUrut: TIntegerField
      FieldName = 'NoUrut'
    end
    ...
    object QuMasterBayarTunai: TBCDField
      FieldName = 'BayarTunai'
      Precision = 18
      Size = 2
    end
    object QuMasterBayarDebet: TBCDField
      FieldName = 'BayarDebet'
      Precision = 18
      Size = 2
    end
    object QuMasterNoDebet: TStringField
      FieldName = 'NoDebet'
      Size = 30
    end
    object QuMasterBankDebet: TStringField
      FieldName = 'BankDebet'
      Size = 30
    end
    object QuMasterBayarKredit: TBCDField
      FieldName = 'BayarKredit'
      Precision = 18
      Size = 2
    end
    object QuMasterTipeKartuKredit: TWordField
      FieldName = 'TipeKartuKredit'
    end
    object QuMasterNoKredit: TStringField
      FieldName = 'NoKredit'
      Size = 30
    end
    object QuMasterBankKredit: TStringField
      FieldName = 'BankKredit'
      Size = 30
    end
    object QuMasterBayarVoucher: TBCDField
      FieldName = 'BayarVoucher'
      Precision = 18
      Size = 2
    end
    object QuMasterVoucherRp: TBCDField
      FieldName = 'VoucherRp'
      Precision = 18
      Size = 2
    end
    ...
    object QuMasterDiscMember: TBCDField
      FieldName = 'DiscMember'
      Precision = 18
      Size = 2
    end
    object QuMasterDiscHarian: TBCDField
    ...
    object QuMasterKodeRekan: TStringField
      FieldName = 'KodeRekan'
      Size = 15
    end
    object QuMasterNoKartuRekan: TStringField
      FieldName = 'NoKartuRekan'
      Size = 50
    end
    object QuMasterDiscRekan: TBCDField
      FieldName = 'DiscRekan'
      Precision = 18
      Size = 2
    end
    ...
    object QuMasterIsOrder: TBooleanField
      FieldName = 'IsOrder'
    end
    object QuMasterIsAmbil: TBooleanField
      FieldName = 'IsAmbil'
    end
    ...
    object QuMasterJamKirim: TStringField
      FieldName = 'JamKirim'
      Size = 8
    end
    object QuMasterPiutang: TBCDField
      FieldName = 'Piutang'
      Precision = 18
      Size = 2
    end
    object QuMasterIsAmbilBrg: TBooleanField
      FieldName = 'IsAmbilBrg'
    end
  end
  object QuDetail1: TADOQuery
    ...
    object QuDetail1DISCP: TBCDField
      FieldName = 'DISCP'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    ...
    object QuDetail1Ctk: TBooleanField
      FieldName = 'Ctk'
    end
    object QuDetail1Diskon: TBCDField
      FieldName = 'Diskon'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    ...
    object QuDetail1subtotal: TBCDField
      FieldName = 'subtotal'
      ReadOnly = True
      DisplayFormat = ',0.00'
      Precision = 32
    ...
    object QuDetail1TglBatal: TDateTimeField
      FieldName = 'TglBatal'
    end
    object QuDetail1isGratis: TBooleanField
      FieldName = 'isGratis'
    end
  ...
  object QuOrderM: TADOQuery
    ...
    Left = 24
    Top = 216
    object QuOrderMNOBUKTI: TStringField
      FieldName = 'NOBUKTI'
    end
    object QuOrderMNoUrut: TIntegerField
      FieldName = 'NoUrut'
    end
    object QuOrderMTANGGAL: TDateTimeField
      FieldName = 'TANGGAL'
    end
    object QuOrderMKODECUST: TStringField
      FieldName = 'KODECUST'
      Size = 15
    end
    object QuOrderMISCETAK: TBooleanField
      FieldName = 'ISCETAK'
    end
    object QuOrderMBayarTunai: TBCDField
      FieldName = 'BayarTunai'
      Precision = 18
      Size = 2
    end
    object QuOrderMBayarDebet: TBCDField
      FieldName = 'BayarDebet'
      Precision = 18
      Size = 2
    end
    object QuOrderMNoDebet: TStringField
      FieldName = 'NoDebet'
      Size = 30
    end
    object QuOrderMBankDebet: TStringField
      FieldName = 'BankDebet'
      Size = 30
    end
    object QuOrderMBayarKredit: TBCDField
      FieldName = 'BayarKredit'
      Precision = 18
      Size = 2
    end
    object QuOrderMTipeKartuKredit: TWordField
      FieldName = 'TipeKartuKredit'
    end
    object QuOrderMNoKredit: TStringField
      FieldName = 'NoKredit'
      Size = 30
    end
    object QuOrderMBankKredit: TStringField
      FieldName = 'BankKredit'
      Size = 30
    end
    object QuOrderMBayarVoucher: TBCDField
      FieldName = 'BayarVoucher'
      Precision = 18
      Size = 2
    end
    object QuOrderMVoucherRp: TBCDField
      FieldName = 'VoucherRp'
      Precision = 18
      Size = 2
    end
    object QuOrderMTglInput: TDateTimeField
      FieldName = 'TglInput'
    end
    object QuOrderMUserID: TStringField
      FieldName = 'UserID'
      Size = 15
    end
    object QuOrderMDiscMember: TBCDField
      FieldName = 'DiscMember'
      Precision = 18
      Size = 2
    end
    object QuOrderMDiscHarian: TBCDField
      FieldName = 'DiscHarian'
      Precision = 18
      Size = 2
    end
    object QuOrderMKeterangan: TStringField
      FieldName = 'Keterangan'
      Size = 30
    end
    object QuOrderMKodeRekan: TStringField
      FieldName = 'KodeRekan'
      Size = 15
    end
    object QuOrderMNoKartuRekan: TStringField
      FieldName = 'NoKartuRekan'
      Size = 50
    end
    object QuOrderMDiscRekan: TBCDField
      FieldName = 'DiscRekan'
      Precision = 18
      Size = 2
    end
    object QuOrderMPemesan: TStringField
      FieldName = 'Pemesan'
      Size = 50
    end
    object QuOrderMIsOrder: TBooleanField
      FieldName = 'IsOrder'
    end
    object QuOrderMAlamat: TStringField
      FieldName = 'Alamat'
      Size = 100
    end
    object QuOrderMTelepon: TStringField
      FieldName = 'Telepon'
    end
    object QuOrderMTanggalAmbil: TDateTimeField
      FieldName = 'TanggalAmbil'
    end
    object QuOrderMDP: TBCDField
      FieldName = 'DP'
      Precision = 18
      Size = 2
    end
    object QuOrderMPiutang: TBCDField
      FieldName = 'Piutang'
      Precision = 18
      Size = 2
    end
  end
  object dsQuOrderM: TDataSource
    DataSet = QuOrderM
    Left = 56
    Top = 216
  end
  ...
  object QuOrderD: TADOQuery
    Connection = DM.MyStock
    CursorType = ctStatic
    DataSource = dsQuOrderM
    Parameters = <
      item
        Name = 'NoBukti'
        DataType = ftString
    ...
    Left = 96
    Top = 216
    object QuOrderDNOBUKTI: TStringField
      FieldName = 'NOBUKTI'
    end
    object QuOrderDURUT: TIntegerField
      FieldName = 'URUT'
    end
    object QuOrderDKodeBrg: TStringField
      FieldName = 'KodeBrg'
      Size = 25
    end
    object QuOrderDHARGA: TBCDField
      FieldName = 'HARGA'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    end
    object QuOrderDDISCP: TBCDField
      FieldName = 'DISCP'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    end
    object QuOrderDQNT: TBCDField
      FieldName = 'QNT'
      DisplayFormat = ',0.0'
      Precision = 18
      Size = 2
    end
    object QuOrderDNOSAT: TWordField
      FieldName = 'NOSAT'
    end
    object QuOrderDSATUAN: TStringField
      FieldName = 'SATUAN'
      Size = 5
    end
    object QuOrderDISI: TBCDField
      FieldName = 'ISI'
      Precision = 18
      Size = 5
    end
    object QuOrderDCtk: TBooleanField
      FieldName = 'Ctk'
    end
    object QuOrderDDiskon: TBCDField
      FieldName = 'Diskon'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    end
    object QuOrderDhrgnetto: TBCDField
      FieldName = 'hrgnetto'
      ReadOnly = True
      DisplayFormat = ',0.00'
      Precision = 32
    ...
    object QuOrderDsubtotal: TBCDField
      FieldName = 'subtotal'
      ReadOnly = True
      DisplayFormat = ',0.00'
      Precision = 32
    ...
    object QuOrderDTglBatal: TDateTimeField
      FieldName = 'TglBatal'
    end
    object QuOrderDisGratis: TBooleanField
      FieldName = 'isGratis'
    end
    object QuOrderDKeterangan: TStringField
      FieldName = 'Keterangan'
      Size = 50
    end
    object QuOrderDIsSelesai: TBooleanField
      FieldName = 'IsSelesai'
    end
    object QuOrderDIsKirim: TBooleanField
      FieldName = 'IsKirim'
    end
    object QuOrderDTakeIn: TBooleanField
      FieldName = 'TakeIn'
    end
    object QuOrderDTakeout: TBooleanField
      FieldName = 'Takeout'
    end
    object QuOrderDNamaBrg: TStringField
      FieldName = 'NamaBrg'
      Size = 100
    end
  end
  object dsQuOrderD: TDataSource
    DataSet = QuOrderD
    Left = 128
    Top = 216
  end
