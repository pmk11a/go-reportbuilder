object FrSPBRJual: TFrSPBRJual
  Left = 125
  Top = 45
  Width = 1030
  Height = 659
  Caption = 'Transaksi Penerimaan Barang Retur Jual'
  Color = clBtnFace
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      '        A.ISCETAK, A.IDUser,'
        ...
        'as, B.QNT QNT1, B.QNT2, B.SAT_1, B.SAT_2, B.NoSat, B.ISI,'
      
        '        B.UrutRPJ, B.netW, b.GrossW, B.Namabrg Namabrgkom, 0.00 ' +
        'GSM,'
      ...
      '             else '#39#39
      '        end Satuan, B.Kodegdg, E.Nama Namagdg'
      'From DBSPBRJual A'
      'left outer join (Select Z.Nobukti, z2.NoBukti NoSC,z3.KODESLS'
      '                 from dbRInvoicePLDet x'
      
        '                      Left outer join dbinvoicePLDet y on Y.nobu' +
        'kti=x.NoInvoice and y.Urut=x.UrutInvoice'
      
        '                      left Outer join dbSPBDet z on z.nobukti=y.' +
        'NoSPB and z.urut=y.UrutSPB'
      
        '                      left Outer join dbSPPDet z1 on z1.NoBukti=' +
        'z.NoSPP and z1.Urut=z.UrutSPP'
      
        '                      left Outer join DBSODET z2 on z2.nobukti=z' +
        '1.noso and z2.urut=z1.UrutSO'
      
        '                      left Outer join DBSO z3 on z3.NOBUKTI=z2.N' +
        'OBUKTI'
      '                 Group by z.Nobukti,z2.NOBUKTI, z3.KODESLS'
      ...
      'Left Outer Join dbGudang E on E.kodegdg=B.Kodegdg'
    ...
    object QuBeliNORPJ: TStringField
      FieldName = 'NORPJ'
      Size = 30
    end
    ...
    object QuBeliUrutRPJ: TIntegerField
      FieldName = 'UrutRPJ'
    end
  ...
  object QuDetailSPB: TADOQuery
    ...
    SQL.Strings = (
      ...
      'from dbSPBLampiran A'
        ...
        'rut, x.NoRPJ,x.UrutRPJ, '#39'Ekspor'#39' Tipe'
      '                      from dbSPBRjualDet x, dbbarang y'
      '                      where x.kodebrg=y.Kodebrg'
      
        '                      )  b on B.nobukti=A.NoSPB and b.urut=a.Uru' +
        'tSPB'
