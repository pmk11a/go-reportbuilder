  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      '        A.ISCETAK, A.IDUser,'
        ...
        '        B.UrutINV, B.netW, b.GrossW, B.Namabrg Namabrgkom, 0.00 ' +
        'GSM,'
      ...
      '             else '#39#39
      '        end Satuan,  B.kodegdg,B.Noinv,B.urutINV'
      'From DBSPBRJual A'
      'Left Outer Join DBSPBRJualDET B on B.NoBukti=A.NoBukti'
      
        'left outer join (Select Y.NoBukti NOinv,Y.Urut urutINV,Z.Nobukti' +
        ', z2.NoBukti NoSC,z3.KODESLS'
      '                 from  dbinvoicePLDet y '
        ...
        '                 Group by z.Nobukti,z2.NOBUKTI, z3.KODESLS,Y.NoB' +
        'ukti,Y.Urut'
      
        '                 ) A1 on A1.NOinv=B.NoINV and A1.urutINV=B.UrutI' +
        'NV '
    ...
    object QuBeliUrutINV: TIntegerField
      FieldName = 'UrutINV'
    end
