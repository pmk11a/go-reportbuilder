  ...
  begin
    ...
    begin
      ...
      begin
        ...
        QuNavigator.Close;
        QuNavigator.SQL.Clear;
        QuNavigator.sql.Add('exec [sp_PORev] '+QuotedStr(QuOSNoBukti.AsString)+',0,0,'+QuotedStr('Revisi')+',0' );
        QuNavigator.ExecSQL;
...
procedure TFrMainPORev.cxGridDBTableView1FocusedRecordChanged(
  Sender: TcxCustomGridTableView; APrevFocusedRecord,
  AFocusedRecord: TcxCustomGridRecord;
  ANewItemRecordFocusingChanged: Boolean);
begin
