object FrHasilP: TFrHasilP
  Left = -8
  Top = -8
  Width = 1382
  Height = 744
  Caption = 'Transaksi Hasil Produksi'
  Color = clBtnFace
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        '.ISI,'
      'B.KodeGdg,NoSPK,c.Nama,HPP,b.kodemsn,shift,ket,'
      
        'NPR1,NPR2,NPR3,NPR4,PR1,PR2,PR3,PR4,TglHasilP,TglSpkMsn,tarifmes' +
        'in,jamproduksi,   JmlTarifPrd,isclosespk,  urutmesin,'
      ...
      'case when f.urutnik=2 then e.trftenaker end trftenaker2,'
      'case when g.urutnik=3 then e.trftenaker end trftenaker3,'
      'case when h.urutnik=4 then e.trftenaker end trftenaker4'
      'from DBHasilPrd A'
      ...
      'left outer join dbmesin d on d.kodemsn=b.kodemsn'
        ...
        'left outer join DBHasilPrdTenaker e on e.nobukti=b.nobukti and b' +
        '.urut=e.urut and e.UrutNiK =1'
      
        'left outer join DBHasilPrdTenaker f on f.nobukti=b.nobukti and b' +
        '.urut=f.urut and f.UrutNiK =2'
      
        'left outer join DBHasilPrdTenaker g on f.nobukti=b.nobukti and b' +
        '.urut=g.urut and g.UrutNiK =3'
      
        'left outer join DBHasilPrdTenaker h on f.nobukti=b.nobukti and b' +
  ...
  object QuTenaker: TADOQuery
    ...
    SQL.Strings = (
      'select * from dbhasilprdtenaker a'
