...
type
  ...
  public
    { Public declarations }
    mPosisi,xStatus,MenuRoduksi : string;
...
var
  FrMainProduksi: TFrMainProduksi;
...
uses MyModul, MyProcedure, MyGlobal, FrmBrows, FrmSetForm,
  FrmProduksi;
{$R *.dfm}
procedure TFrMainProduksi.SimpanSPP(IsSimpan:Boolean);
begin
  if IsSimpan then
    begin
      With Sp_Beli do
...
procedure TFrMainProduksi.GetData(bulan,tahun:integer);
begin
  QuNavigator.Close;
...
procedure TFrMainProduksi.Save(ADefaultExt, AFilter, AFileName: String; AMethod: TSaveMethod);
begin
  with SaveDialog do
  begin
...
procedure TFrMainProduksi.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TFrMainProduksi.FormDestroy(Sender: TObject);
begin
  FrMainHasilP:=nil;
end;

procedure TFrMainProduksi.FormShow(Sender: TObject);
begin
...
procedure TFrMainProduksi.ToolButton10Click(Sender: TObject);
begin
   GetData(StrToInt(PeriodBln),StrToInt(PeriodThn));
end;

procedure TFrMainProduksi.ToolButton9Click(Sender: TObject);
begin
   Close;
end;

procedure TFrMainProduksi.ExportExcel1Click(Sender: TObject);
begin
  with QuView do
  begin
    Close;
...
procedure TFrMainProduksi.AutoFilter1Click(Sender: TObject);
begin
...
procedure TFrMainProduksi.ShowGrid1Click(Sender: TObject);
begin
...
procedure TFrMainProduksi.ShowHeader1Click(Sender: TObject);
begin
...
procedure TFrMainProduksi.Show1Click(Sender: TObject);
begin
...
procedure TFrMainProduksi.ToolButton1Click(Sender: TObject);
begin
...
procedure TFrMainProduksi.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrMainProduksi.ToolButton2Click(Sender: TObject);
begin
  if IsLockPeriode(StrToInt(PeriodBln),StrToInt(PeriodThn)) then
  begin
    if IsKoreksi then
...
procedure TFrMainProduksi.MultiSelect1Click(Sender: TObject);
begin
...
procedure TFrMainProduksi.dxDBGrid1MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TFrMainProduksi.TampilValidClick(Sender: TObject);
begin
...
procedure TFrMainProduksi.TampilBatalClick(Sender: TObject);
begin
...
procedure TFrMainProduksi.FormCreate(Sender: TObject);
begin
  Panel1.Color:=FrSetForm.PanelMain.Color;
  ToolBar1.Color:=FrSetForm.ToolBarMain.Color;
end;

procedure TFrMainProduksi.tvMasterFocusedRecordChanged(
...
procedure TFrMainProduksi.ToolButton4Click(Sender: TObject);
begin
if Iscetak then
...
procedure TFrMainProduksi.frxReport1AfterPrintReport(Sender: TObject);
begin
NilaiCetak('CetakKe','DBHasilPrd',QuMasterNoBukti.AsString);
end;

procedure TFrMainProduksi.frxReport1GetValue(const VarName: String;
  var Value: Variant);
begin
...
procedure TFrMainProduksi.ToolButton12Click(Sender: TObject);
begin
...
procedure TFrMainProduksi.ToolButton13Click(Sender: TObject);
begin
  BM := QuMaster.GetBookmark;
  {frLogin := TFrLogin.Create(Self);
  frLogin.Label2.Caption :='Otorisasi';
