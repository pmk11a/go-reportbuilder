object FrKreditN: TFrKreditN
  Left = 128
  Top = 124
  Width = 1167
  Height = 630
  Caption = 'Transaksi Kredit Note'
  Color = clBtnFace
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
      'select '#9'@NoBukti='#39'SJY/KN/0413/00001'#39
      ''
      ...
      '        a.Nilai,'
        ...
        'aiValas,'
      '        a.kodeVls, a.Kurs, a.NilaiRp ,a.urutinvoicepl'
    ...
    object QuBeliurutinvoicepl: TIntegerField
      FieldName = 'urutinvoicepl'
    end
  end
  object Sp_Beli: TADOStoredProc
    Connection = DM.MyStock
    ProcedureName = 'Sp_KreditNote;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
