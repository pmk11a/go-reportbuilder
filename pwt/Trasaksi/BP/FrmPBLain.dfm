object FrPBLain: TFrPBLain
  Left = 312
  Top = 8
  Width = 800
  Height = 646
  Caption = 'Transaksi PB Lain'
  Color = clBtnFace
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
      'Select '#9'A.NoBukti,A.Nourut,A.Tanggal,A.Kodegdg,A.NoBPPB,'
      ' B.urut, B.Kodebrg,'
      ...
      ' D.Isi2, D.NFix, B.UrutSPK, B.NoSatSPK,'
        ...
        ' Convert(Numeric(18,2),0) Stok, Convert(Numeric(18,2),0) QntBppB' +
        ', Convert(Numeric(18,2),0) QntBP, Convert(Numeric(18,2),0) sisa,'
      ' B.Nospk ,b.keterangan,perkiraan'
    ...
    object QuBeliQntBppB: TBCDField
      FieldName = 'QntBppB'
      ReadOnly = True
      Precision = 18
      Size = 2
    ...
    object QuBeliUrutSPK: TIntegerField
      FieldName = 'UrutSPK'
    end
    object QuBeliNoSatSPK: TWordField
      FieldName = 'NoSatSPK'
    end
  ...
  object Sp_Beli: TADOStoredProc
    Connection = DM.MyStock
    ProcedureName = 'sp_PenyerahanBhn;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
