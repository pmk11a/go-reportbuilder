object FrRPBLain: TFrRPBLain
  Left = 145
  Top = 55
  Width = 800
  Height = 646
  Caption = 'Transaksi RPB Lain'
  Color = clBtnFace
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'Select '#9'd.Isi2,d.Nfix,A.NoBukti,A.Nourut,A.Tanggal,A.Kodegdg,A.N' +
        'oPenyerahanBhn,'
      
        '        B.urut,B.Kodebrg,B.Qnt,Qnt2,B.Isi,B.Nosat,B.Sat,D.NamaBr' +
        'g,Convert(Numeric(18,2),0) Stok,'
      
        '        Convert(Numeric(18,2),0) Stok2,Convert(Numeric(18,2),0) ' +
        'QntBP,Convert(Numeric(18,2),0) Qnt2BP,'
      
        '        Convert(Numeric(18,2),0) QntRBP,Convert(Numeric(18,2),0)' +
        ' Qnt2RBP,Convert(Numeric(18,2),0) sisa,'
      '        B.UrutPenyerahanBHN, b.keterangan'
      ...
      'where'#9'A.NoBukti=@NoBukti and A.IsSampel=0'
      'order by B.Urut'
      ''
      ''
      ''
    ...
    object QuBeliStok: TBCDField
      FieldName = 'Stok'
      ReadOnly = True
      Precision = 18
      Size = 2
    end
    object QuBelisisa: TBCDField
      FieldName = 'sisa'
      ReadOnly = True
      Precision = 18
      Size = 2
    end
    object QuBeliQntBP: TBCDField
      FieldName = 'QntBP'
      ReadOnly = True
      Precision = 18
      Size = 2
    ...
    object QuBeliNoPenyerahanBhn: TStringField
      FieldName = 'NoPenyerahanBhn'
      Size = 30
    end
    object QuBeliStok2: TBCDField
      FieldName = 'Stok2'
      ReadOnly = True
      Precision = 18
      Size = 2
    end
    object QuBeliQnt2BP: TBCDField
      FieldName = 'Qnt2BP'
      ReadOnly = True
      Precision = 18
      Size = 2
    end
    object QuBeliQntRBP: TBCDField
      FieldName = 'QntRBP'
      ReadOnly = True
      Precision = 18
      Size = 2
    end
    object QuBeliQnt2RBP: TBCDField
      FieldName = 'Qnt2RBP'
      ReadOnly = True
      Precision = 18
      Size = 2
    ...
    object QuBeliUrutPenyerahanBHN: TIntegerField
      FieldName = 'UrutPenyerahanBHN'
    end
  ...
  object Sp_Beli: TADOStoredProc
    Connection = DM.MyStock
    ProcedureName = 'Sp_RPenyerahanBhn;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
