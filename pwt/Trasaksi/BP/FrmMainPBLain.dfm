object FrMainPBLain: TFrMainPBLain
  Left = -4
  Top = -4
  Width = 1928
  Height = 892
  Caption = 'Penyerahan Bahan(BP) Bahan Lain'
  Color = 16773589
    ...
    object dxTabSheet1: TdxTabSheet
      ...
      object cxGrid2: TcxGrid
        ...
        object tvPO: TcxGridDBTableView
          OnKeyDown = tvPOKeyDown
          OnKeyUp = tvPOKeyDown
          OnMouseDown = tvPOMouseDown
          OnMouseUp = tvPOMouseDown
          ...
          OnCustomDrawCell = tvPOCustomDrawCell
          ...
          object tvPOQntSPK: TcxGridDBColumn
            Caption = 'Qnt SPK'
            DataBinding.FieldName = 'QntSPK'
            HeaderAlignmentHorz = taRightJustify
            Width = 90
          end
          object tvPOQntPakai: TcxGridDBColumn
            Caption = 'Qnt Pakai'
            DataBinding.FieldName = 'QntPakai'
            HeaderAlignmentHorz = taRightJustify
            Width = 90
          end
  ...
  object QuMaster: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
      'Select '#9'A.NoBukti, A.Tanggal,KodeGdg, nospk,noso,'
      ...
      'left outer join dbPenyerahanBhndet b on a.nobukti=b.nobukti'
      'left outer join dbspk c on c.nobukti=b.nospk'
      'where year(A.Tanggal)=@Tahun and month(A.Tanggal)=@Bulan and'
      '      A.IsSampel=0 and ISNULL(Flagtipe ,0)=1'
      'group by a.Nobukti ,A.Tanggal ,Kodegdg ,NoSPK ,NoSO '
      
        #9',A.IsOtorisasi1, A.OtoUser1, A.TglOto1, A.IsOtorisasi2, A.OtoUs' +
        'er2, A.TglOto2,'
      
        #9'A.IsOtorisasi3, A.OtoUser3, A.TglOto3, A.IsOtorisasi4, A.OtoUse' +
        'r4, A.TglOto4,'
      #9'A.IsOtorisasi5, A.OtoUser5, A.TglOto5,a.MaxOL'
      'order by a.Kodegdg ,A.NoBukti'
      ''
      ''
      '')
    Left = 24
  ...
  object QuBPPB: TADOQuery
    ...
    SQL.Strings = (
      ...
      'where A.QntSisa>0 and isotorisasi1=1 and b.tanggal>='#39'2015-1-1'#39
      'order by B.Tanggal, A.NoBukti, A.Urut'
      '')
    Left = 24
    Top = 216
    object QuBPPBNOBUKTI: TStringField
      FieldName = 'NOBUKTI'
      ReadOnly = True
      Size = 30
    end
    object QuBPPBTANGGAL: TDateTimeField
      FieldName = 'TANGGAL'
    end
    object QuBPPBURUT: TIntegerField
      FieldName = 'URUT'
      ReadOnly = True
    end
    ...
    object QuBPPBNOSAT: TWordField
      FieldName = 'NOSAT'
      ReadOnly = True
    end
    object QuBPPBSatuan: TStringField
      FieldName = 'Satuan'
      ReadOnly = True
      Size = 5
    end
    object QuBPPBQntSPK: TBCDField
      FieldName = 'QntSPK'
      ReadOnly = True
      DisplayFormat = ',0.00'
      Precision = 32
    ...
    object QuBPPBQntPakai: TBCDField
      FieldName = 'QntPakai'
      ReadOnly = True
      DisplayFormat = ',0.00'
      Precision = 32
    ...
    object QuBPPBQntSisa: TBCDField
      FieldName = 'QntSisa'
      ReadOnly = True
      DisplayFormat = ',0.00'
      Precision = 32
  ...
  object PopupMenu3: TPopupMenu
    ...
    object CetakPO1: TMenuItem
      Caption = 'Cetak Gudang'
      OnClick = CetakPO1Click
    end
    object CetakPOTanpaHarga1: TMenuItem
      Caption = 'Cetak Produksi'
      OnClick = CetakPOTanpaHarga1Click
    end
    object Prepress1: TMenuItem
      Caption = 'Cetak Prepress'
      OnClick = Prepress1Click
    end
  end
end
