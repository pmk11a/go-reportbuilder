    ...
    object dxPageControl1: TdxPageControl
      ...
      object dxTabSheet2: TdxTabSheet
        ...
        object dxDBGrid2: TdxDBGrid
          ...
          object dxDBGrid2Column1: TdxDBGridDateColumn
            Caption = 'Tanggal Kirim'
            BandIndex = 0
            RowIndex = 0
            FieldName = 'Tanggal'
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      #9'B.Urut, B.KodeBrg, E.NamaBrg, B.Satuan, B.Qnt, B.Nosat, B.Isi,'
        ...
        '        B.Harga, B.DISCP, B.DISCTOT,NoPPL,A.IsClose,B.IsClose Is' +
        'CloseD,'
      ...
      'Left Outer Join vwMasterPO H on H.NoBukti=A.NoBukti'
        ...
        'Left Outer Join (select NoBukti,KodeBrg,Max(Tanggal)Tanggal from' +
        ' DBKirimDET group By NoBukti,KodeBrg) J On J.KodeBrg=B.KodeBrg a' +
