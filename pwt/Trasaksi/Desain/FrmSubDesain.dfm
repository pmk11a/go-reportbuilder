object FrSubDesain: TFrSubDesain
  Left = 441
  Top = 0
  ...
  object Konsep: TCheckBox
    Left = 112
    Top = 229
    Width = 97
    Height = 17
    Caption = 'Konsep Desain'
    TabOrder = 9
  end
  object Softcopy: TCheckBox
    Left = 224
    Top = 229
    Width = 97
    Height = 17
  ...
  object KetMeeting: TComboBox
    ...
    ItemIndex = 0
    TabOrder = 14
    Text = 'Tidak Dapat Dikerjakan'
    Items.Strings = (
      'Tidak Dapat Dikerjakan'
      'Dapat Dikerjakan'
      'Dapat dikerjakan dengan modifikasi')
  end
  object QntSample: TPBNumEdit
    Left = 113
    Top = 416
    Width = 40
    Height = 19
