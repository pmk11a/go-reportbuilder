object FrMainBPPBT: TFrMainBPPBT
  Left = 385
  Top = 230
  Width = 969
  Height = 479
    ...
    object dxTabSheet1: TdxTabSheet
      object cxGrid2: TcxGrid
        ...
        object tvPO: TcxGridDBTableView
          DataController.DataSource = dsMasterPO
          ...
          object tvPONMDEP: TcxGridDBColumn
            Caption = 'Departemen'
          ...
          object tvPOKDDEP: TcxGridDBColumn
            DataBinding.FieldName = 'KDDEP'
            Visible = False
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          end
          object tvPOKodeGdg: TcxGridDBColumn
            Caption = 'Gudang'
          ...
          object tvPOURUT: TcxGridDBColumn
          ...
          object tvPONOSAT: TcxGridDBColumn
            DataBinding.FieldName = 'NOSAT'
            Visible = False
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          end
          object tvPOSatuan: TcxGridDBColumn
            Caption = 'Sat'
          ...
          object tvPOQntBPSB: TcxGridDBColumn
            Caption = 'Qnt Terima'
            DataBinding.FieldName = 'QntBPPBT'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Width = 90
          end
          object tvPOQntSisa: TcxGridDBColumn
            Caption = 'Qnt Sisa'
    ...
    object dxTabSheet2: TdxTabSheet
      ...
      object cxGrid1: TcxGrid
        ...
        object tvMaster: TcxGridDBTableView
          ...
          object tvMasterKdDep: TcxGridDBColumn
          ...
          object tvMasterNmDep: TcxGridDBColumn
          ...
          object tvMasterKodeGdg: TcxGridDBColumn
            Caption = 'Kode Gudang'
            DataBinding.FieldName = 'KodeGdg'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
  ...
  object QuMaster: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'Select '#9'A.NoUrut, A.NoBukti, A.Tanggal, A.KdDep, C.NmDep, A.Kode' +
        'Gdg,'
    ...
    object QuMasterKdDep: TStringField
      FieldName = 'KdDep'
    end
  ...
  object QumasterPO: TADOQuery
    Connection = DM.MyStock
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'declare @Tahun int, @Bulan int, @Periode Varchar(6)'
      ''
      ...
      ''
      'select A.NOBUKTI, B.TANGGAL, B.KodeGdg, B.KDDEP, Dp.NMDEP,'
      'A.URUT, A.KODEBRG, Br.NAMABRG, A.NOSAT,'
      'case when A.NoSat=1 then Br.Sat1 else Br.Sat2 end Satuan,'
      'case when A.NoSat=1 then A.Qnt else A.Qnt2 End Qnt,'
      
        'case when A.NoSat=1 then A.QntBPPBT else A.Qnt2BPPBT End QntBPPB' +
        'T,'
      'case when A.NoSat=1 then A.QntSisa else A.Qnt2Sisa End QntSisa'
      'from vwOutBPPB A'
      'left outer join DBBPPB B on B.NOBUKTI=A.NoBukti'
      'left outer join DBDEPART Dp on Dp.KDDEP=B.KDDEP'
      'left outer join DBBARANG Br on Br.KODEBRG=A.KodeBrg'
      
        'where A.QntSisa>0 and Cast(Case when Case when B.IsOtorisasi1=1 ' +
        'then 1 else 0 end+'
      
        '                       Case when B.IsOtorisasi2=1 then 1 else 0 ' +
        'end+'
      
        '                       Case when B.IsOtorisasi3=1 then 1 else 0 ' +
        'end+'
      
        '                       Case when B.IsOtorisasi4=1 then 1 else 0 ' +
        'end+'
      
        '                       Case when B.IsOtorisasi5=1 then 1 else 0 ' +
        'end=B.MaxOL then 0'
      '                  else 1'
      '             end As Bit)=0 and'
      
        '      cast(year(B.Tanggal) as varchar(4))+Case when month(B.tang' +
        'gal)<10 then '#39'0'#39' else '#39#39' end+Cast(month(B.Tanggal) as varchar(2)' +
        ')<=@Periode'
      'order by B.Tanggal, A.NoBukti, A.Urut')
    Left = 24
    Top = 250
    object QumasterPONOBUKTI: TStringField
      FieldName = 'NOBUKTI'
      ReadOnly = True
      Size = 50
    end
    object QumasterPOTANGGAL: TDateTimeField
      FieldName = 'TANGGAL'
    end
    object QumasterPOKodeGdg: TStringField
      FieldName = 'KodeGdg'
      Size = 15
    end
    object QumasterPOKDDEP: TStringField
      FieldName = 'KDDEP'
    end
    object QumasterPONMDEP: TStringField
      FieldName = 'NMDEP'
      Size = 40
    end
    object QumasterPOURUT: TIntegerField
      FieldName = 'URUT'
      ReadOnly = True
    end
    object QumasterPOKODEBRG: TStringField
      FieldName = 'KODEBRG'
      ReadOnly = True
      Size = 25
    end
    object QumasterPONAMABRG: TStringField
      FieldName = 'NAMABRG'
      Size = 100
    end
    object QumasterPONOSAT: TWordField
      FieldName = 'NOSAT'
      ReadOnly = True
    end
    object QumasterPOSatuan: TStringField
      FieldName = 'Satuan'
      ReadOnly = True
      Size = 5
    end
    object QumasterPOQntSisa: TBCDField
      FieldName = 'QntSisa'
      ReadOnly = True
      DisplayFormat = ',0.00'
      Precision = 32
    ...
    object QumasterPOQnt: TBCDField
      FieldName = 'Qnt'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    end
    object QumasterPOQntBPPBT: TBCDField
      FieldName = 'QntBPPBT'
      ReadOnly = True
      DisplayFormat = ',0.00'
      Precision = 32
