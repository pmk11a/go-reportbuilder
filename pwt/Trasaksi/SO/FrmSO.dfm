object FrSO: TFrSO
  ...
  object Panel1: TPanel
    ...
    object LNamaSubCustomer: TLabel
      Left = 198
      Top = 101
      Width = 177
      Height = 16
    ...
    object Numerator: TCheckBox
      ...
      Caption = 'Numerator'
      TabOrder = 25
      OnClick = TanggalChange
      OnExit = NumeratorExit
      OnKeyDown = TANGGALKeyDown
    end
    object BhnKertas: TMemo
      Left = 58
      Top = 176
      Width = 300
      Height = 30
    ...
    object Verifikasi: TMemo
      ...
      TabOrder = 31
      OnChange = TanggalChange
      OnExit = VerifikasiExit
    end
    object Sekuriti: TMemo
      Left = 426
      Top = 172
      Width = 300
      Height = 137
    ...
    object KodeSubCust: TEdit
      ...
      OnChange = TanggalChange
      OnEnter = KodeCustEnter
      OnExit = KodeSubCustExit
      OnKeyDown = TANGGALKeyDown
    end
    object UkuranKertas: TMemo
      Left = 58
      Top = 208
      Width = 300
      Height = 30
    ...
    object Panel5: TPanel
      ...
      object cxGrid1: TcxGrid
        ...
        object tvPrices: TcxGridDBBandedTableView
          ...
          object tvPricesDBBandedColumn1: TcxGridDBBandedColumn
            Caption = '%1'
          ...
          object tvPricesDBBandedColumn2: TcxGridDBBandedColumn
            Caption = '%2'
            DataBinding.FieldName = 'Discp2'
            HeaderAlignmentHorz = taCenter
            Width = 40
          ...
          object tvPricesDBBandedColumn3: TcxGridDBBandedColumn
            Caption = '%3'
          ...
          object tvPricesDBBandedColumn4: TcxGridDBBandedColumn
            Caption = '%4'
          ...
          object tvPricesDBBandedColumn5: TcxGridDBBandedColumn
            Caption = '%5'
            DataBinding.FieldName = 'Discp5'
            HeaderAlignmentHorz = taCenter
            Width = 40
            Position.BandIndex = 0
          ...
          object tvPricesDBBandedColumn6: TcxGridDBBandedColumn
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'UST,  M2.NAMACUSTSUPP NamaCust,'
      '        A.NoAlamatKirim, J.Alamat AlamatKirim,'
      
        #9'A.Handling, A.NOSPB, Cast(A.KodeSls as varchar(200)) kodesls,  ' +
        'M1.Nama NamaSls, A.KodeGdg, A.Keterangan, A.KodeVls, D.NamaVls, ' +
        'A.Kurs, A.PPN, '
      ...
      '        B.Discp2,Discp3,Discp4,Discp5,'
        ...
        '        ltrim(M2.ALAMAT1+case when ltrim(m2.ALAMAT2)<>'#39#39' then ch' +
        'ar(13)+M2.ALAMAT2 else '#39#39' end+'
      
        #9'case when ltrim(isnull(M2.KOTA,'#39#39'))<>'#39#39' then char(13)+isnull(M2' +
        '.KOTA,'#39#39')+'#39' '#39'+M2.KodePos else '#39#39' end) ALAMAT'
      
        '        ,numerator ,BahanKertas , TeknikCetak ,Sekuriti ,Finsihi' +
        'ng,b.iscetakkitir ,logo ,urutnumerator1,urutnumerator2'
      
        '        ,a.kodesubcustomer, e.namasubcustomer,UkuranKertas ,jeni' +
        'sso,nodesain,Orientasi,ppnp'
      'From dbSO A'
      ...
      'Left OUter Join DBCUSTSUPP M2 on A.KODECUST=M2.KODECUSTSUPP'
      
        'left outer join dbsubcustomer E on e.kodesubcustomer =a.kodesubc' +
        'ustomer'
    ...
    object QuBelinumerator: TBooleanField
      FieldName = 'numerator'
    end
    object QuBeliBahanKertas: TStringField
      FieldName = 'BahanKertas'
      Size = 2000
    end
    object QuBeliTeknikCetak: TStringField
      FieldName = 'TeknikCetak'
      Size = 2000
    end
    object QuBeliSekuriti: TStringField
      FieldName = 'Sekuriti'
      Size = 2000
    end
    object QuBeliFinsihing: TStringField
      FieldName = 'Finsihing'
      Size = 2000
    end
    object QuBeliiscetakkitir: TBooleanField
      FieldName = 'iscetakkitir'
    end
    object QuBelilogo: TBooleanField
      FieldName = 'logo'
    end
    object QuBeliurutnumerator1: TStringField
      FieldName = 'urutnumerator1'
      Size = 15
    end
    object QuBeliurutnumerator2: TStringField
      FieldName = 'urutnumerator2'
      Size = 15
    end
    object QuBelikodesubcustomer: TStringField
      FieldName = 'kodesubcustomer'
      Size = 30
    end
    object QuBelinamasubcustomer: TStringField
      FieldName = 'namasubcustomer'
      Size = 200
    end
    object QuBeliUkuranKertas: TStringField
      FieldName = 'UkuranKertas'
      Size = 500
    end
    ...
    object QuBelijenisso: TWordField
      FieldName = 'jenisso'
    end
    object QuBelinodesain: TStringField
      FieldName = 'nodesain'
      Size = 30
    end
    object QuBeliOrientasi: TWordField
      FieldName = 'Orientasi'
    end
  ...
  object QuLastPrices: TADOQuery
    ...
    SQL.Strings = (
      ...
      '            else '#39#39
        ...
        'rg) as LineNum ,'
      '       X.Discp1,x.Discp2,X.Discp3,X.Discp4,X.Discp5,X.DiscTOt'
      'FROM dbo.DBBARANG p'
      ...
      '                  pc.Harga Price,                  '
        ...
        '                        Pc.Discp1,PC.Discp2,Pc.Discp3,Pc.Discp4,' +
        'Pc.Discp5,Pc.DiscTot'
      ''
      '             FROM dbo.DBSODET pc'
    ...
    object QuLastPricesDiscp1: TBCDField
      FieldName = 'Discp1'
      DisplayFormat = '0'
      Precision = 18
      Size = 2
    end
    object QuLastPricesDiscp2: TBCDField
      FieldName = 'Discp2'
      DisplayFormat = '0'
      Precision = 18
      Size = 2
    end
    object QuLastPricesDiscp3: TBCDField
      FieldName = 'Discp3'
      DisplayFormat = '0'
      Precision = 18
      Size = 2
    end
    object QuLastPricesDiscp4: TBCDField
      FieldName = 'Discp4'
      DisplayFormat = '0'
      Precision = 18
      Size = 2
    end
    object QuLastPricesDiscp5: TBCDField
      FieldName = 'Discp5'
      DisplayFormat = '0'
      Precision = 18
      Size = 2
    end
    object QuLastPricesDiscTOt: TBCDField
      FieldName = 'DiscTOt'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
