object FrMainPOOut: TFrMainPOOut
  Left = -4
  Top = -4
  Width = 1374
  Height = 742
    ...
    object dxTabSheet1: TdxTabSheet
      ...
      object cxGrid2: TcxGrid
        ...
        object tvMasterOut: TcxGridDBTableView
          ...
          object tvMasterOutDBColumn3: TcxGridDBColumn
            Caption = 'Supplier'
  ...
  object QuMaster: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'Rp, TotNetRp,'
      '        b.kodebrg,b.namabrg,qnt,qntsisa,qntterima,'
      ...
      '       ,b.Isbatal,b.UserBatal,b.TglBatal,satuan,B.Urut'
      
        'From dbPO a Left Outer Join vwMasterPOOut b on a.NoBukti=b.NoBuk' +
        'ti'
      
        'where b.qntbatal<>0          --year(a.Tanggal)=@Tahun and month(' +
        'a.Tanggal)=@Bulan and '
      'order by NoBukti'
      ''
      ''
    ...
    object QuMasterTotDiskon: TBCDField
      FieldName = 'TotDiskon'
      ReadOnly = True
      Precision = 2
      Size = 2
    end
    object QuMasterTotTotal: TBCDField
      FieldName = 'TotTotal'
      ReadOnly = True
      Precision = 2
      Size = 2
    end
    object QuMasterTotDPP: TBCDField
      FieldName = 'TotDPP'
      ReadOnly = True
      Precision = 2
      Size = 2
    end
    object QuMasterTotPPN: TBCDField
      FieldName = 'TotPPN'
      ReadOnly = True
      Precision = 2
      Size = 2
    end
    object QuMasterTotNet: TBCDField
      FieldName = 'TotNet'
      ReadOnly = True
      Precision = 2
      Size = 2
    ...
    object QuMasterTotDiskonRp: TBCDField
      FieldName = 'TotDiskonRp'
      ReadOnly = True
      Precision = 2
      Size = 2
    end
    object QuMasterTotTotalRp: TBCDField
      FieldName = 'TotTotalRp'
      ReadOnly = True
      Precision = 2
      Size = 2
    end
    object QuMasterTotDPPRp: TBCDField
      FieldName = 'TotDPPRp'
      ReadOnly = True
      Precision = 2
      Size = 2
    end
    object QuMasterTotPPNRp: TBCDField
      FieldName = 'TotPPNRp'
      ReadOnly = True
      Precision = 2
      Size = 2
    end
    object QuMasterTotNetRp: TBCDField
      FieldName = 'TotNetRp'
      ReadOnly = True
      Precision = 2
      Size = 2
    end
    object QuMastersatuan: TStringField
      FieldName = 'satuan'
      Size = 5
    end
  ...
  object QuPPL: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'select  a.qntterima,A.NoBukti+'#39' '#39'+right('#39'00000000'#39'+cast(A.urut a' +
        's varchar(8)),8) KeyUrut,'
      'A.*'
      'from vwOutPOBatal A'
      'where QntSisa>0 and A.QntBatal=0'
    ...
    object QuPPLSatuan: TStringField
      FieldName = 'Satuan'
      Size = 5
    end
    ...
    object QuPPLNAMACUSTSUPP: TStringField
      FieldName = 'NAMACUSTSUPP'
      Size = 100
    end
