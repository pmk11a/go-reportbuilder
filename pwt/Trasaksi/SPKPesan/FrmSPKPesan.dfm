object FrSPKPesan: TFrSPKPesan
  Left = 330
  Top = 0
  Width = 800
  Height = 630
  Caption = 'Transaksi SPK'
  Color = clBtnFace
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'Select '#9'B.urut,A.NoBukti, A.NoBatch, A.TglExpired, A.tanggal,Rig' +
        'ht(A.NoBukti,4) NoUrut,'
  ...
  object QuPesan: TADOQuery
    ...
    Left = 334
    Top = 112
    object QuPesanNoBukti: TStringField
      FieldName = 'NoBukti'
    end
    object QuPesanUrut: TIntegerField
      FieldName = 'Urut'
    end
  end
  object DsPesan: TDataSource
    DataSet = QuPesan
    Left = 362
    Top = 112
  end
