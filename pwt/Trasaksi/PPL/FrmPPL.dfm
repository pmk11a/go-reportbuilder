  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'Select '#9'A.*,B.*,case when d.Proses =1 then NamaBarang  else d.NA' +
        'MABRG '
      'end Namabrg --D.Namabrg'
      ', C.NMDep,d.proses Jasa'
      'From dbPPL A'
    ...
    object QuBeliIsClose_1: TBooleanField
      FieldName = 'IsClose_1'
    end
    ...
    object QuBeliNamaBArang: TStringField
      FieldName = 'NamaBArang'
      Size = 1000
    end
    object QuBeliJasa: TIntegerField
      FieldName = 'Jasa'
    end
