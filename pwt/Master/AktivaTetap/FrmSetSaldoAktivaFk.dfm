object FrSetSaldoAktivaFk: TFrSetSaldoAktivaFk
  Left = 411
  Top = 260
  ...
  object QuSetStock: TADOQuery
    ...
    SQL.Strings = (
      ...
      'from dbAktivadetFK a'
      '        left outer join dbaktivaFK b on b.perkiraan=a.perkiraan'
  ...
  object Sp_SetQnt: TADOStoredProc
    Connection = DM.MyStock
    ProcedureName = 'SP_AktivaDetFK;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
