...
begin
  ...
  begin
    ...
    begin
      ...
      {Parameters[13].Value := Quview.fieldbyname('biaya2').AsString; }
    end
    else
    begin
      ...
      Parameters[25].Value := frSubAktiva.PersenPajak.Value;
    end;
    try
      ExecProc;
      if Choice='I' then
...
begin
   ...
   begin
     ...
     persenpajak.Value:=QuView.FieldByname('PersenPajak').AsFloat;
   end;
end;
