object FrSubPostBiaya: TFrSubPostBiaya
  Left = 435
  Top = 217
  ...
  object KodeJnsPakai: TEdit
    ...
    ParentFont = False
    TabOrder = 1
    OnEnter = KodeJnsPakaiEnter
    OnExit = KodeJnsPakaiExit
  end
  ...
  object BiayaJasa: TEdit
    ...
    ParentFont = False
    TabOrder = 3
    OnEnter = BiayaJasaEnter
    OnExit = BiayaJasaExit
  end
end
