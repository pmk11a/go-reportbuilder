object FrbarangCust: TFrbarangCust
  ...
  object QuBeli: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select A.KodeCustSupp, a.kodebrg,a.harga,B.NamaBrg,'
      'C.NamaCustSupp  from DbbarangCustomer  A'
      'left outer join dbbarang b on a.kodebrg = B.kodebrg'
      'left outer join dbcustsupp C on A.Kodecustsupp=C.kodecustsupp'
      'where A.kodecustSupp like '#39'%%'#39
  ...
  object QuKomisi: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select A.KodeCustSupp, A.urut,a.Nama,a.Kurir,A.islunas,B.namaCus' +
        'tSupp from dbkomisicustomer A'
