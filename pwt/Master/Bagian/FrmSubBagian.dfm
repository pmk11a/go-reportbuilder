object FrSubBagian: TFrSubBagian
  Left = 293
  Top = 230
  ...
  object lNamaBiayaJasaKom: TLabel
    Left = 224
    Top = 163
    Width = 38
    Height = 16
  ...
  object lNamaBiayaJasaAlat: TLabel
    Left = 224
    Top = 189
    Width = 38
    Height = 16
  ...
  object KodeBrd: TEdit
    ...
    ShowHint = False
    TabOrder = 0
    OnEnter = KodeBrdEnter
    OnExit = KodeBrdExit
  end
  object NamaBrd: TEdit
    Left = 122
    Top = 83
    Width = 471
    Height = 24
  ...
  object BiayaPersediaan: TEdit
    ...
    TabOrder = 3
    OnEnter = PerkiraanEnter
    OnExit = BiayaPersediaanExit
  end
  object BiayaJasaKom: TEdit
    Left = 122
    Top = 160
    Width = 95
    Height = 24
    ...
    ParentFont = False
    TabOrder = 4
    OnEnter = BiayaJasaKomEnter
    OnExit = BiayaJasaKomExit
  end
  object BiayaJasaAlat: TEdit
    Left = 122
    Top = 186
    Width = 95
    Height = 24
    ...
    ParentFont = False
    TabOrder = 5
    OnEnter = BiayaJasaAlatEnter
    OnExit = BiayaJasaAlatExit
  end
end
