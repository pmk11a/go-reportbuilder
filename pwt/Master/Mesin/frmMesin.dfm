object FrMesin: TFrMesin
  ...
  object QuView: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select A.KodeMsn,A.Ket,A.KodePrs,tarif Kapasitas,B.Keterangan Ke' +
        'tProses '
      'from DBMesin A'
      'Left Outer Join DBPRoses B on A.KodePrs=B.KodePrs')
    Left = 234
    Top = 149
    ...
    object QuViewKapasitas: TBCDField
      FieldName = 'Kapasitas'
      Precision = 18
      Size = 2
    end
