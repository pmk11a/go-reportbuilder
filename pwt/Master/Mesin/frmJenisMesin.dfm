object FrJenisMesin: TFrJenisMesin
  Left = 580
  Top = 237
  Width = 696
  Height = 480
  ...
  object dxDBGrid1: TdxDBGrid
    ...
    object dxDBGrid1KodeJenisMesin: TdxDBGridMaskColumn
      BandIndex = 0
      RowIndex = 0
      FieldName = 'KodeJenisMesin'
    end
  ...
  object QuView: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select * from dbjenismesin')
    Left = 234
    Top = 149
    object QuViewKodeJenisMesin: TStringField
      FieldName = 'KodeJenisMesin'
      Size = 10
    end
