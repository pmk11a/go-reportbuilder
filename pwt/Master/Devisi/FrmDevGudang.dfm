object FrdevGudang: TFrdevGudang
  Left = 466
  Top = 146
  ...
  object QuView: TADOQuery
    ...
    SQL.Strings = (
      ...
      'select  @Devisi='#39#39
      ''
      'Select A.devisi,C.Namadevisi,B.Kodegdg,B.nama NamaGdg'
      'from DbDevGudang A'
      'Left outer join DbGudang B  on A.KodeGDg= B.kodeGdg'
      'Left Outer Join DbDevisi C on A.Devisi=C.Devisi'
      'where A.devisi=@devisi'
      'order by a.DeVisi')
    Left = 298
    Top = 21
