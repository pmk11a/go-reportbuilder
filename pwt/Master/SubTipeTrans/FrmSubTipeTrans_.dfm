object FrSubTipeTrans_: TFrSubTipeTrans_
  Left = 435
  Top = 219
  ...
  object KodeSubKategori: TEdit
    ...
    ShowHint = False
    TabOrder = 1
    OnEnter = KodeSubKategoriEnter
    OnExit = KodeSubKategoriExit
  end
  object NamaSubKategori: TEdit
    Left = 146
    Top = 105
    Width = 343
    Height = 24
  ...
  object KodeKategori: TEdit
    ...
    ParentFont = False
    TabOrder = 0
    OnEnter = KodeKategoriEnter
    OnExit = KodeKategoriExit
  end
