object FrPajak: TFrPajak
  ...
  object dxDBGrid1: TdxDBGrid
    ...
    object dxDBGrid1Service: TdxDBGridMaskColumn
      Alignment = taCenter
      Caption = 'Service ( % )'
      HeaderAlignment = taCenter
      BandIndex = 0
  ...
  object QuView: TADOQuery
    ...
    object QuViewPPn: TIntegerField
      FieldName = 'PPn'
      DisplayFormat = ',0.00'
    end
    object QuViewService: TIntegerField
      FieldName = 'Service'
      DisplayFormat = ',0.00'
    end
  end
  ...
  object sp_barang: TADOStoredProc
    Connection = DM.MyStock
    ProcedureName = 'Sp_MasterPajak;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
