object FrTarifTenaker: TFrTarifTenaker
  Left = 456
  Top = 20
  Width = 1382
  Height = 744
  Caption = 'Tarif Tenaga Kerja'
  Color = 16773589
  ...
  object dxDBGrid1: TdxDBGrid
    ...
    object dxDBGrid1KodeTarifTenaker: TdxDBGridMaskColumn
      Caption = 'Kode Tarif'
      BandIndex = 0
      RowIndex = 0
      FieldName = 'KodeTarifTenaker'
    end
    object dxDBGrid1Ket: TdxDBGridMaskColumn
      Caption = 'Keterangan'
      BandIndex = 0
      RowIndex = 0
      FieldName = 'Ket'
    ...
    object dxDBGrid1Tarif: TdxDBGridMaskColumn
      BandIndex = 0
      RowIndex = 0
      FieldName = 'Tarif'
    end
  ...
  object Sp_Merk: TADOStoredProc
    Connection = DM.MyStock
    ProcedureName = 'Sp_TarifTenaker;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
