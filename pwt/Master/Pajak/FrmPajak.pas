...
begin
   ...
   begin
     ...
     Bulan.Value :=QuViewUrut.AsFloat ;
     PPn.Value := QuViewPersen.AsFloat;
...
begin
   ...
   begin
     ...
     begin
        ...
        Parameters[3].Value:=PPn.Value ;
        Parameters[4].Value:=Pilihan.Checked;
        //Parameters[5].Value:=Service.Value;
     end
     else
     begin
        Parameters[2].Value:=QuViewUrut.AsFloat;
        //Parameters[3].Value:=QuViewPilihan.AsInteger;
     end;
