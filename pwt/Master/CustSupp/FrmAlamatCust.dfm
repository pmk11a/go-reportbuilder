object FrAlamatCust: TFrAlamatCust
  ...
  object Panel2: TPanel
    ...
    object dxDBGrid1: TdxDBGrid
      ...
      object dxDBGrid1NamaKota: TdxDBGridMaskColumn
        Caption = 'Kota'
        Width = 120
        BandIndex = 0
        RowIndex = 0
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select A.KodeCust, A.Nomor, A.NamaKirim, A.Alamat, A.Kota, A.Kod' +
        'eExp, C.NamaExp, cast(A.Alamat as text) AlamatTxt, B.NamaKota'
      'from dbAlamatCust A'
      'left outer join dbKota B on B.KodeKota=A.Kota'
      'left outer join dbExpedisi C on C.KodeExp=A.KodeExp'
      ''
      'where 1=1')
    Left = 107
    Top = 82
    ...
    object QuBeliNamaKota: TStringField
      FieldName = 'NamaKota'
      Size = 30
    end
