object FrSubGroup_JnsTambah: TFrSubGroup_JnsTambah
  Left = 400
  Top = 66
  ...
  object Panel2: TPanel
    ...
    object dxDBGrid1: TdxDBGrid
      ...
      object dxDBGrid1Kode: TdxDBGridMaskColumn
        Visible = False
        BandIndex = 0
        RowIndex = 0
        FieldName = 'Kode'
  ...
  object QuBeli: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select '#9'*, KodeGrp+KodeSubGrp Kode'
      'from '#9'DBSubGroupJnsTambah a'
      'left outer join dbdepart b on b.kddep=a.keterangan'
      ''
      ''
      ''
      ''
    ...
    object QuBeliKode: TStringField
      FieldName = 'Kode'
      ReadOnly = True
      Size = 23
    end
