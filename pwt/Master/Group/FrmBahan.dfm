object FrBahan: TFrBahan
  ...
  object QuView: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'Select * from dbJBAHAN'
      'order by kdBHN')
    Left = 50
    Top = 45
    object QuViewKDBHN: TStringField
      FieldName = 'KDBHN'
    end
    object QuViewNAMABHN: TStringField
      FieldName = 'NAMABHN'
      Size = 50
    end
  end
  ...
  object Sp_JBAHAN: TADOStoredProc
    Connection = DM.MyStock
    ProcedureName = 'Sp_JBAHAN;1'
    Parameters = <>
    Left = 529
    Top = 104
  end
