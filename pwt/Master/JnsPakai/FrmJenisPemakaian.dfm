object FrJenisPemakaian: TFrJenisPemakaian
  ...
  object QuView: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'Select * from dbJnsPakai'
      'order by KodeJnsPakai')
    Left = 50
    Top = 45
    object QuViewKodeJNSPakai: TStringField
      FieldName = 'KodeJNSPakai'
      Size = 15
    end
