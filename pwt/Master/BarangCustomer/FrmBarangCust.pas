...
begin
  QuKomisi.Close;
  QuKomisi.Prepared;
  QuKomisi.Parameters[0].Value :=mKodeCust_AlamatCust;
  QuKomisi.Open;
end;
...
begin
   ...
   begin
     ...
     DM.QuCari.SQL.Add('where KodeCustSupp='+QuotedStr(mKodeCust_AlamatCust)+'');
     DM.QuCari.Prepared;
   ...
   begin
     ...
     DM.QuCari.SQL.Add('where KodeCustsupp='+QuotedStr(mKodeCust_AlamatCust)+' and kodebrg ='+QuotedStr(QuBelikodebrg.AsString));
     DM.QuCari.Prepared;
   end;
...
begin
   ...
   begin
     ...
     begin
       Close;
       SQL.Clear;
       SQL.Add('select max(Urut)Urut from DbkomisiCustomer where KodeCustSupp='+QuotedStr(mKodeCust_AlamatCust));
       Open;
     end;
   ...
   begin
     ...
     DM.QuCari.SQL.Add('where KodeCustSupp='+QuotedStr(mKodeCust_AlamatCust)+' and Urut=:2');
     DM.QuCari.Prepared;
   ...
   begin
     ...
     DM.QuCari.SQL.Add('where KodeCustsupp='+QuotedStr(mKodeCust_AlamatCust)+' and Urut=:0');
