object FrJenisTambahan: TFrJenisTambahan
  Left = 196
  Top = 201
  Width = 696
  Height = 480
  ...
  object QuView: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'Select * from DBJNSTambahan'
      'order by KodeJNSTambahan')
    Left = 50
    Top = 85
    object QuViewKodeJnsTambahan: TStringField
      FieldName = 'KodeJnsTambahan'
    end
  ...
  object Sp_JenisTambahan: TADOStoredProc
    Connection = DM.MyStock
    ProcedureName = 'Sp_JnsTambahan;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
