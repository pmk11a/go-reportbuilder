object FrGudang: TFrGudang
  ...
  object dxDBGrid1: TdxDBGrid
    ...
    object dxDBGrid1Column4: TdxDBGridCheckColumn
      Caption = 'Take In & Take Out'
      MinWidth = 20
      Visible = False
      Width = 100
      BandIndex = 0
      RowIndex = 0
      FieldName = 'IsTakeInOut2'
      ValueChecked = 'True'
      ValueUnchecked = 'False'
    end
  end
  object QuView: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select *,Isnull(IsTakeInOut,0)IsTakeInOut2 from dbGudang order b' +
        'y kodegdg')
    Left = 50
    Top = 77
    ...
    object QuViewFlagMenu: TIntegerField
      FieldName = 'FlagMenu'
    end
    ...
    object QuViewIsTakeInOut2: TBooleanField
      FieldName = 'IsTakeInOut2'
      ReadOnly = True
    end
  end
