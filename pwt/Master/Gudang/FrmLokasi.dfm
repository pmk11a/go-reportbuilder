object FrLokasi: TFrLokasi
    ...
    object dxTabSheet1: TdxTabSheet
      ...
      object Panel2: TPanel
        ...
        object cxGrid2: TcxGrid
          ...
          object TvLokasi: TcxGridDBTableView
            DataController.DataSource = DsView
            DataController.DetailKeyFieldNames = 'lokasi'
          ...
          object TVBrgLokasi: TcxGridDBTableView
            DataController.DataSource = DS3
            DataController.DetailKeyFieldNames = 'lokasi'
            DataController.Filter.Criteria = {FFFFFFFF0000000000}
            DataController.KeyFieldNames = 'lokasi'
            DataController.MasterKeyFieldNames = 'lokasi'
            DataController.Summary.DefaultGroupSummaryItems = <>
            DataController.Summary.FooterSummaryItems = <
              item
                Format = ',0.00'
            ...
            object TVBrgLokasiDBColumn1: TcxGridDBColumn
              Caption = 'Kode Barang'
              DataBinding.FieldName = 'Kodebrg'
              Width = 90
            end
            object TVBrgLokasiDBColumn2: TcxGridDBColumn
              Caption = 'Nama Barang'
    ...
    object dxTabSheet2: TdxTabSheet
      ...
      object Panel4: TPanel
        ...
        object dxDBGrid1: TdxDBGrid
          ...
          object dxDBGrid1Lokasi: TdxDBGridColumn
            BandIndex = 0
            RowIndex = 0
            FieldName = 'lokasi'
          end
      ...
      object Panel6: TPanel
        ...
        object Kodebrg: TEdit
          ...
          OnExit = KodebrgExit
          OnKeyDown = Lokasi2KeyDown
        end
        object Lokasi2: TEdit
          Left = 99
          Top = 13
          Width = 134
          Height = 24
  ...
  object QuView: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
      'select  @kodeGdg='#39#39
      ''
      'Select  A.KODEGDG,A.NAMA,B.lokasi '
      'from DBGUDANG A'
      'Left Outer Join DbLokasi B on A.KODEGDG = B.kodegdg'
    ...
    object QuViewlokasi: TStringField
      FieldName = 'lokasi'
      Size = 15
    end
  end
  ...
  object Quview2: TADOQuery
    ...
    Left = 450
    Top = 21
    object Quview2KODEGDG: TStringField
      FieldName = 'KODEGDG'
      Size = 15
    end
    ...
    object Quview2lokasi: TStringField
      FieldName = 'lokasi'
      Size = 15
    end
  end
  ...
  object QuView3: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'declare @kodeGdg Varchar(15),@Lokasi varchar(10)'
      ''
      'select  @kodeGdg='#39#39',@Lokasi='#39#39
      ''
      'Select  A.KODEGDG,A.Lokasi,A.KOdebrg,B.NamaBrg,C.Nama'
      'from DbBarangLokasi A'
      'Left Outer Join Dbbarang B on A.Kodebrg = B.kodeBrg'
      'Left Outer Join DbGudang C on A.KodeGDG = C.KodeGDG'
      'where A.KODEGDG=@kodeGdg  --and C.Lokasi =@Lokasi'
      'order by A.lokasi')
    Left = 554
    Top = 21
    object QuView3KODEGDG: TStringField
      FieldName = 'KODEGDG'
      Size = 15
    end
    object QuView3Lokasi: TStringField
      FieldName = 'Lokasi'
      Size = 10
    end
    object QuView3KOdebrg: TStringField
      FieldName = 'KOdebrg'
      Size = 25
    end
    object QuView3NamaBrg: TStringField
      FieldName = 'NamaBrg'
      Size = 100
    end
    object QuView3Nama: TStringField
      FieldName = 'Nama'
      Size = 40
    end
  end
