object FrSubEkspedisi: TFrSubEkspedisi
  Left = 406
  Top = 188
  ...
  object KodeEksped: TEdit
    ...
    ParentFont = False
    TabOrder = 0
    OnEnter = KodeEkspedEnter
    OnExit = KodeEkspedExit
  end
  object NamaEksped: TEdit
    Left = 113
    Top = 92
    Width = 344
    Height = 24
