object FrSubLapArusKas: TFrSubLapArusKas
  Left = 404
  Top = 212
  ...
  object Aktivitas: TEdit
    ...
    ParentFont = False
    TabOrder = 4
    OnEnter = AktivitasEnter
    OnExit = AktivitasExit
  end
  object SubAktivitas: TEdit
    Left = 112
    Top = 176
    Width = 100
    Height = 24
