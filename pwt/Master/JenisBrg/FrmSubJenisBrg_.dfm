object FrSubJenisBrg_: TFrSubJenisBrg_
  Left = 195
  Top = 115
  Width = 854
  Height = 480
  ...
  object dxDBGrid1: TdxDBGrid
    ...
    object dxDBGrid1KodeJNSPakai: TdxDBGridMaskColumn
      Caption = 'Kode Sub Jenis'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Tahoma'
    ...
    object dxDBGrid1KodeJnsBrg: TdxDBGridMaskColumn
      Caption = 'Kode Jenis Barang'
      HeaderAlignment = taCenter
      Width = 109
      BandIndex = 0
      RowIndex = 0
      FieldName = 'KodeJnsBrg'
    end
    object dxDBGrid1NamaJns: TdxDBGridMaskColumn
      Caption = 'Nama Jenis'
      HeaderAlignment = taCenter
      Width = 218
      BandIndex = 0
  ...
  object QuView: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'Select a.*,B.Keterangan NamaJns'
      'from dbSubJenis a'
      '        left outer join dbJenis B on B.kodejnsBrg=A.KodeJnsBrg'
      'order by KodeSubJnsBrg')
    Left = 42
    Top = 85
    object QuViewkodesubJnsBrg: TStringField
      FieldName = 'kodesubJnsBrg'
      Size = 15
    end
    ...
    object QuViewKodeJnsBrg: TStringField
      FieldName = 'KodeJnsBrg'
      Size = 15
    end
    object QuViewNamaJns: TStringField
      FieldName = 'NamaJns'
      Size = 100
    end
  end
  ...
  object Sp_Merk: TADOStoredProc
    Connection = DM.MyStock
    ProcedureName = 'Sp_SubJnsBarang;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
