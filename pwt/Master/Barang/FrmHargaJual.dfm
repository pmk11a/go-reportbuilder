object FrHargaJual: TFrHargaJual
  Left = 519
  Top = 100
  ...
  object QuView: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
      'select  @KodeBrg='#39#39
      ''
      
        'Select A.KOdebrg,C.NamaBrg,A.KodeJenisCustSupp,B.NamaJenis,A.Har' +
        'ga1,A.Harga2'
      'from DBHargaJual A'
      
        'Left outer join DBJenisCustSupp B  on A.KodejenisCustSupp= B.Kod' +
        'eJenis'
      'Left Outer Join DBbarang C on A.KodeBrg=C.Kodebrg'
      'where A.Kodebrg=@Kodebrg'
      'order by a.KodeJenisCustSupp')
    Left = 298
    Top = 21
    ...
    object QuViewKodeJenisCustSupp: TStringField
      FieldName = 'KodeJenisCustSupp'
      Size = 15
    end
    ...
    object QuViewHarga1: TBCDField
      FieldName = 'Harga1'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    end
    object QuViewHarga2: TBCDField
      FieldName = 'Harga2'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
