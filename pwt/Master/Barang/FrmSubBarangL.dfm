object FrSubBarangL: TFrSubBarangL
  Left = 266
  Top = 103
  ...
  object KodeAcc: TEdit
    ...
    TabOrder = 25
    Visible = False
    OnEnter = KodeAccEnter
  end
  object KodeSubAcc: TEdit
    Left = 112
    Top = 275
    Width = 73
    Height = 24
