object FrBarangL: TFrBarangL
  Left = 152
  Top = 68
  Width = 800
  Height = 480
  Caption = 'Master Barang WIP'
  Color = 16773589
  ...
  object dxDBGrid1: TdxDBGrid
    ...
    object dxDBGrid1MyNFix: TdxDBGridMaskColumn
      Visible = False
      BandIndex = 1
      RowIndex = 0
      FieldName = 'MyNFix'
    ...
    object dxDBGrid1KODESUBGRP: TdxDBGridMaskColumn
      Visible = False
      BandIndex = 1
      RowIndex = 0
    ...
    object dxDBGrid1KODESUPP: TdxDBGridMaskColumn
      Caption = 'Supplier'
      Visible = False
      Width = 70
      BandIndex = 1
  ...
  object QuView: TADOQuery
    ...
    SQL.Strings = (
      ...
      'Select  A.*'
      'from    vwBarang A'
      'where ((A.IsAktif=@IsAktif and @IsAktif<>2) or @IsAktif=2)'
      'and A.IsBarang=2'
      'Order by A.Kodebrg'
      '')
    Left = 34
    ...
    object QuViewMyNFix: TStringField
      FieldName = 'MyNFix'
      ReadOnly = True
      Size = 30
    end
    ...
    object QuViewIsBarang: TWordField
      FieldName = 'IsBarang'
    end
    object QuViewIsBeli: TWordField
      FieldName = 'IsBeli'
      ReadOnly = True
    end
    object QuViewIsJual: TWordField
      FieldName = 'IsJual'
      ReadOnly = True
    end
  end
