object FrUMHutangAwal: TFrUMHutangAwal
  Left = 277
  Top = 249
  BorderStyle = bsDialog
  Caption = 'Uang Muka Hutang Awal'
  ClientHeight = 190
  ClientWidth = 464
  Color = clBtnFace
  ...
  object Panel3: TPanel
    ...
    object Debet: TPBNumEdit
      ...
      OnChange = DebetChange
      ParentFont = False
      TabOrder = 5
    end
    object DebetRp: TPBNumEdit
      Left = 329
      Top = 102
      Width = 116
      Height = 24
  ...
  object Sp_Beli: TADOStoredProc
    ...
    ProcedureName = 'Sp_UMHutangAwal;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
