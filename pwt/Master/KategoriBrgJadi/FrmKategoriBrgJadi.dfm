object FrKategoriBrgJadi: TFrKategoriBrgJadi
  Left = 196
  Top = 114
  Width = 696
  Height = 480
  Caption = 'Kategori Barang Jadi'
  Color = 16773589
  ...
  object dxDBGrid1: TdxDBGrid
    ...
    object dxDBGrid1COA: TdxDBGridMaskColumn
      HeaderAlignment = taCenter
      Visible = False
      Width = 250
      BandIndex = 0
    ...
    object dxDBGrid1Biaya_1: TdxDBGridMaskColumn
      Caption = 'Biaya'
      HeaderAlignment = taCenter
      Visible = False
      Width = 250
  ...
  object Sp_Merk: TADOStoredProc
    Connection = DM.MyStock
    ProcedureName = 'Sp_KategoriBrgJadi;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
