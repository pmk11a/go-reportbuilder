object FrSubValas_: TFrSubValas_
  Left = 345
  Top = 126
  ...
  object Panel2: TPanel
    ...
    object dxDBGrid1: TdxDBGrid
      ...
      object dxDBGrid1NamaVls: TdxDBGridMaskColumn
        Caption = 'Keterangan'
        HeaderAlignment = taCenter
        Width = 169
        BandIndex = 0
  ...
  object QuBeli: TADOQuery
    ...
    SQL.Strings = (
      'select '#9'B.kodevls,a.Tanggal,A.Kurs, B.NamaVls'
      'from dbValas b'
      
        '     left outer join dbValasdet a on a.kodevls = b.kodevls and a' +
        '.tanggal=:0'
      'Order by B.kodevls')
    Left = 104
    Top = 114
  ...
  object Sp_Beli: TADOStoredProc
    Connection = DM.MyStock
    ProcedureName = 'SP_SetKursHarian;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
