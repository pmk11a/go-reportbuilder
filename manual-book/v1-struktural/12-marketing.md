# Bab 12 — Transaksi Marketing (Penjualan)
...
- Solusi: lakukan produksi (lihat [Bab 14 Produksi](14-produksi.md)) atau transfer stok dari gudang lain.
...
- **Gudang ([Bab 13](13-gudang.md))** → Setiap DO otomatis kurangi stok di kartu stok.
