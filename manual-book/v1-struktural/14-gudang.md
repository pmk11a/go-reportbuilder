# Bab 14 — Transaksi Gudang (Warehouse)
...
- **Barang yang sudah diretur (RPB/RPJ)** akan menambah/kurangi stok sesuai kondisi barang (lihat [Bab 11](11-purchasing.md) dan [Bab 13](13-marketing.md)).
...
- **Marketing ([Bab 13](13-marketing.md))** → DO otomatis kurangi stok; RPJ otomatis tambah stok.
- **Produksi ([Bab 15](15-produksi.md))** → output produksi tambah stok barang jadi; bahan baku yang dipakai kurangi stok bahan baku.
