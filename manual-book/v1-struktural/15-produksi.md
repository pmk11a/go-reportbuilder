# Bab 15 — Transaksi Produksi (Production)
...
| SO Acuan (opsional) | Dropdown | - | Jika produksi untuk memenuhi SO tertentu (lihat [Bab 13](13-marketing.md)) |
...
- **Marketing ([Bab 13](13-marketing.md))** → SO bisa menjadi acuan JO (Make to Order).
- **Gudang ([Bab 14](14-gudang.md))** → Release kurangi stok bahan, penyelesaian tambah stok barang jadi.
