...
import { ArrowLeft, Edit, Trash2, User, Loader2, AlertCircle } from 'lucide-react'
...
import { UserOverviewTab } from '@/components/admin/users/tabs/UserOverviewTab'
import { UserPermissionsTab } from '@/components/admin/users/tabs/UserPermissionsTab'
import { UserSessionsTab } from '@/components/admin/users/tabs/UserSessionsTab'
  ...
  return (
    <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                <div className="flex items-center gap-4 flex-1 min-w-0">
                  <div className="h-14 w-14 rounded-full bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center text-white text-xl font-bold shadow-lg shrink-0">
                    {u.full_name?.charAt(0)?.toUpperCase() || u.user_id.charAt(0).toUpperCase()}
                  </div>
      ...
      <ConfirmDialog
        ...
        confirmText={t('detail.delete_button', 'Delete')}
