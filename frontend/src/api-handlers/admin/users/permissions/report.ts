...
/**
 * BFF proxy for the per-tab REPORT permissions endpoint.
 * Frontend URL: GET /api/admin/users/permissions/report?id={id}
 * Backend URL:  GET /api/admin/users/{id}/permissions/report
 */
