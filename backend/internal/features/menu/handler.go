...
func NewMenuHandler(menuService IMenuService) *SMenuHandler {
...
func (h *SMenuHandler) GetAllMenus(c *gin.Context) {
	...
	paginatedMenus, err := h.menuService.GetPaginatedMenus(page, limit, search)
	if err != nil {
		responsepkg.InternalError(c, "Failed to retrieve menus")
		return
	}
	responsepkg.Success(c, "Menus retrieved successfully", paginatedMenus)
}
...
// @Accept json
// @Produce json
// @Param request body SDbMenu true "Menu Data"
...
// @Produce json
// @Param kode path string true "Menu Code"
// @Param request body SDbMenu true "Updated Menu Data"
// @Success 200 {object} map[string]interface{}
// @Failure 400 {object} map[string]interface{}
// @Security BearerAuth
